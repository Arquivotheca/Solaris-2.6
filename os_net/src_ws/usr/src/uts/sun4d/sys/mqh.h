/*
 * Copyright (c) 1989, 1991, 1993 by Sun Microsystems, Inc.
 */

#ifndef	_SYS_MQH_H
#define	_SYS_MQH_H

#pragma ident	"@(#)mqh.h	3.14	94/03/08 SMI"
...
#define	MQH_ERR_TO_SYN(a)	(u_int)(((a) & MQH_ERR_SYN_MASK) >> \
					MQH_ERR_SYN_SHIFT)
#define	MQH_ERR_ADDR_MASK	(0x0000000FFFFFFFFF)
#define	MQH_ERR_TO_PAGE(a)	(u_int)((((a) & MQH_ERR_ADDR_MASK)) \
						>> MMU_PAGESHIFT)
...
#define	mqh_get_cid(a) (lda_2f((u_int *)((a)|MQH_OFF_CID)) & ~CID_VERS_MSK)
...
#define	mqh_get_adr0(a) lda_2f((u_int *)((a)|MQH_OFF_ADR_G0))
#define	mqh_get_adr1(a) lda_2f((u_int *)((a)|MQH_OFF_ADR_G1))
#define	mqh_get_adr2(a) lda_2f((u_int *)((a)|MQH_OFF_ADR_G2))
#define	mqh_get_adr3(a) lda_2f((u_int *)((a)|MQH_OFF_ADR_G3))
