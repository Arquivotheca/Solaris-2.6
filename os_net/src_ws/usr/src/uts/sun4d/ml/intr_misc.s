...
#ident	"@(#)intr_misc.s	1.41	94/10/12 SMI"
...
/* ARGSUSED */
int
intr_tick_get_phyaddr(int cpuid)
{ return (0); }

#else	/* lint */

	ENTRY_NP(intr_tick_get_phyaddr)
	CPUidtoBWcsrid(%o0, %o0)
	set TICK_COUNTER, %o1
	retl
	or %o0, %o1, %o0
	SET_SIZE(intr_tick_get_phyaddr)
...
/* ARGSUSED */
void
intr_mxcc_error_set(longlong_t v)
{}
