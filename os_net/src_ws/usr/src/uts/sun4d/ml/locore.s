...
#pragma ident	"@(#)locore.s	1.307	96/10/30 SMI"
...
{}
	...
	! in sun4d locore...see bug 1248925).
...
5:
	...
	mov	%l0, %psr
	wr	%l0, PSR_ET, %psr	! enable traps, but hold %pil
	nop; nop; nop
...
9:
	...
	call	lock_set
	mov	%l6, %o0
	sethi	%hi(clock_pend), %g1	! psr delay 
