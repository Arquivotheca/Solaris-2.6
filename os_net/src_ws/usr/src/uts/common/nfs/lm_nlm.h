...
#pragma ident	"@(#)lm_nlm.h	1.10	94/12/14 SMI"	/* NCR OS2.00.00 1.1 */
 ...
 */
#define	NLM_VERS2	((u_long)2)
#define	PRV_CRASH	((u_long)17)
#define	PRV_RECOVERY	((u_long)18)

#define	NLM_VERS3	((u_long)3)
...
#define	NLM4_VERS ((unsigned long)(4))

#define	NLMPROC4_NULL ((unsigned long)(0))
#define	NLMPROC4_TEST ((unsigned long)(1))
#define	NLMPROC4_LOCK ((unsigned long)(2))
#define	NLMPROC4_CANCEL ((unsigned long)(3))
#define	NLMPROC4_UNLOCK ((unsigned long)(4))
#define	NLMPROC4_GRANTED ((unsigned long)(5))
#define	NLMPROC4_TEST_MSG ((unsigned long)(6))
#define	NLMPROC4_LOCK_MSG ((unsigned long)(7))
#define	NLMPROC4_CANCEL_MSG ((unsigned long)(8))
#define	NLMPROC4_UNLOCK_MSG ((unsigned long)(9))
#define	NLMPROC4_GRANTED_MSG ((unsigned long)(10))
#define	NLMPROC4_TEST_RES ((unsigned long)(11))
#define	NLMPROC4_LOCK_RES ((unsigned long)(12))
#define	NLMPROC4_CANCEL_RES ((unsigned long)(13))
#define	NLMPROC4_UNLOCK_RES ((unsigned long)(14))
#define	NLMPROC4_GRANTED_RES ((unsigned long)(15))
#define	NLMPROC4_SHARE ((unsigned long)(20))
#define	NLMPROC4_UNSHARE ((unsigned long)(21))
#define	NLMPROC4_NM_LOCK ((unsigned long)(22))
#define	NLMPROC4_FREE_ALL ((unsigned long)(23))
