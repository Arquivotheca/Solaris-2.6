...
#pragma ident	"@(#)mount.h	1.20	96/04/08 SMI"	/* SVr4.0 1.5	*/
...
#define	NFS_ARGS_EXT1	1
#define	NFS_ARGS_EXT2	2

/*
 * extension data for nfs_args_ext == NFS_ARGS_EXT1.
 */
struct nfs_args_ext1 {
	struct sec_data		*secdata;	/* security data */
};

/*
 * extension data for nfs_args_ext == NFS_ARGS_EXT2.
 */
struct nfs_args_ext2 {
	struct sec_data		*secdata;	/* security data */
 ...
 */
union nfs_ext {
	struct nfs_args_ext1	nfs_ext1;	/* nfs_args extension v1 */
	struct nfs_args_ext2	nfs_ext2;	/* nfs_args extension v2 */
};
