...
#pragma ident	"@(#)nfs_acl.h	1.4	96/04/02 SMI"
...
extern int acl2call(mntinfo_t *, int, xdrproc_t, caddr_t, xdrproc_t,
			caddr_t, cred_t *, int *, enum nfsstat *, int,
			failinfo_t *);
extern int acl3call(mntinfo_t *, int, xdrproc_t, caddr_t, xdrproc_t,
