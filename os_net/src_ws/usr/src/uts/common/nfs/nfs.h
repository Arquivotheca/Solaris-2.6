...
#pragma ident	"@(#)nfs.h	1.67	96/10/16 SMI"	/* SVr4.0 1.5	*/
...
#define	n2v_type(x)	(NA_ISFIFO(x) ? VFIFO : \
		(((x)->na_type == NFSOC) ? VSOCK : (enum vtype)((x)->na_type)))
...
extern int	mount_root(struct knetconfig *, char *, struct netbuf *,
			fhandle_t *, char *, char *);
extern int	nfsrootvp(vnode_t **, vfs_t *, struct servinfo *,
			int, cred_t *);
...
extern int	mount3_root(struct knetconfig *, char *, struct netbuf *,
			nfs_fh3 *, char *, char *);
extern int	nfs3rootvp(vnode_t **, vfs_t *, struct servinfo *,
			int, cred_t *);
