 ...
 * Copyright (c) 1990, 1994, 1996 by Sun Microsystem, Inc.
 */

#pragma ident   "@(#)hsfs_vfsops.c 1.47     96/05/30 SMI"
	...
	register struct statvfs64 *sbp;
{
	...
	sbp->f_bfree = (fsblkcnt64_t) -1;
	sbp->f_bavail = (fsblkcnt64_t) -1;
