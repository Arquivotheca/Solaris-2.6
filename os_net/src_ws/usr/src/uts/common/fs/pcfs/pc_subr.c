...
#pragma ident "@(#)pc_subr.c 1.8     94/08/10 SMI"
...
localtime(time_t *tim)
{
	...
	copyt = *tim - (long)pc_tz.secondswest;
	ct = gmtime(copyt);
	dayno = ct->tm_yday;
