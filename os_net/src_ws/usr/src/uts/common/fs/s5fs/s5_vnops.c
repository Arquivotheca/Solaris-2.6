...
#pragma ident   "@(#)s5_vnops.c	1.24    96/07/28 SMI"
...
static int s5_frlock(register struct vnode *vp, int cmd, struct flock64 *bfp,
...
static int s5_putpage(register struct vnode *vp, offset_t off, u_int len,
    int flags, struct cred *cr);
int s5_putapage(struct vnode *vp, page_t *pp, u_offset_t *offp, u_int *lenp,
    int flags, struct cred *cr);
...
/* ARGSUSED */
static int
s5_frlock(register struct vnode *vp, int cmd, struct flock64 *bfp,
    int flag, offset_t offset, cred_t *cr)
{
	register struct inode *ip = VTOI(vp);
...
/*ARGSUSED*/
int
s5_putapage(struct vnode *vp, page_t *pp, u_offset_t *offp, u_int *lenp,
    int flags, struct cred *cr)
{
	register struct inode *ip;
