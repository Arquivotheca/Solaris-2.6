...
#pragma ident   "@(#)s5_vfsops.c	1.6    96/01/10 SMI"
...
static int s5_statvfs(register struct vfs *vfsp, struct statvfs64 *sp);
 ...
 */
static int
s5_statvfs(register struct vfs *vfsp, struct statvfs64 *sp)
{
