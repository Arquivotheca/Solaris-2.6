/*
 * Copyright (C) 1987-1990, 1996 by Sun Microsystems, Inc.
 * All Rights Reserved.
 */

#ident	"@(#)kbd.c	1.104	96/10/17 SMI"	/* SunOS-4.0 1.60	*/
...
static void
kbdtranslate(register struct kbddata *kbdd, register unsigned keycode,
    register queue_t *q)
{
	register u_char key;
