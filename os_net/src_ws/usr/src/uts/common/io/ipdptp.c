...
#pragma ident "@(#)ipdptp.c 1.8 94/01/04 Copyright 1992 SMI"
...
static int		ipdptp_detach(dev_info_t *, ddi_detach_cmd_t cmd);
...
{
	dev_t 			dev = (dev_t) arg;
	register struct ipd_str	*ptp;
	register int 		instance, rc;
