...
#ident	"@(#)connld.c	1.32	95/03/03 SMI"	/* SVr4 1.8	*/
 ...
 */
int connopen(queue_t *rqp, dev_t *devp, int flag, int sflag, cred_t *crp);
int connclose(queue_t *q, int cflag, cred_t *crp);
int connput(queue_t *q, mblk_t *bp);
