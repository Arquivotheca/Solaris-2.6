...
#include <sys/errno.h>
#include <inet/common.h>  /* For u32 definition. */
#include "md5.h"
	...
	MD5_CTX *context;					 /* context */
{
	 ...
	 */
	context->state[0] = (u32) 0x67452301;
	context->state[1] = (u32) 0xefcdab89;
	context->state[2] = (u32) 0x98badcfe;
	context->state[3] = (u32) 0x10325476;
}
