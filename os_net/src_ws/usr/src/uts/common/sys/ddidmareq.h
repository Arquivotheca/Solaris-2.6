/*
 * Copyright (c) by 1990-1996, by Sun Microsystems, Inc.
 * All rights reserved.
 */
...
#pragma ident	"@(#)ddidmareq.h	1.22	96/09/24 SMI"
...
/*
 * It's possible that this should be #if sparc / #elif i386/ppc / #else err
 * but I don't know for sure.  If the apparently-extended code on i386/ppc
