...
#pragma ident	"@(#)swapnode.h	1.12	93/05/25 SMI"
...
struct swapnode {
	...
	u_int			swap_vnum;	/* Unique id of this swapnode */
 ...
 */
extern int swapfs_minfree;		/* amount of availrmem (in pages) */
					/*   that is unavailable to swapfs */
extern int swapfs_desfree;

extern struct vnodeops swap_vnodeops;
extern struct vfsops swap_vfsops;
extern struct vnode *swapfs_getvp(u_int);
