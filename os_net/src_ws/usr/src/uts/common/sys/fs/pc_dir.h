...
#pragma ident	"@(#)pc_dir.h	1.7	93/09/29 SMI"
...
struct pctime {
	u_short pct_time;		/* hh:mm:ss (little endian) */
	u_short pct_date;		/* yy:mm:dd (little endian) */
};
...
struct pcdir {
	...
	pc_cluster_t pcd_scluster;	/* starting cluster (little endian) */
