 ...
 * Copyright (c) 1989-1994 by Sun Microsystems, Inc.  All Rights Reserved.
 */

#ifndef	_SYS_FS_HSFS_ISOSPEC_H
#define	_SYS_FS_HSFS_ISOSPEC_H

#pragma ident	"@(#)hsfs_isospec.h	1.9	94/09/19 SMI"
...
#elif defined(sparc) || defined(__sparc) || defined(__ppc)
/*
 * Sparc and PPC machines require that integers must
