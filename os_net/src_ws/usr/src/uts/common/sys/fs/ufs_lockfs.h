...
#pragma ident	"@(#)ufs_lockfs.h	1.17	94/10/28 SMI"
...
#define	ULOCKFS_FIOAI_MASK	(ULOCKFS_HLOCK | ULOCKFS_ELOCK | ULOCKFS_SLOCK)
...
struct ulockfs {
	u_long		ul_flag;	/* flags */
	u_long		ul_fs_lock;	/* current file system lock state */
	u_long		ul_fs_mod;	/* for test; fs was modified */
	u_long		ul_vnops_cnt;	/* # of active ufs vnops outstanding */
