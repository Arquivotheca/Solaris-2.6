...
#pragma ident	"@(#)ufs_fs.h	2.50	96/09/04 SMI"
...
#else
#define	UFS_MAXOFFSET_T	((1LL << NBBY * sizeof (daddr_t) + DEV_BSHIFT - 1) - 1)
...
/*
 * The value of fsb in both the following macros cannot be greater
 * than a 32 bit value as daddr_t is still a 32 bit type.
 */
