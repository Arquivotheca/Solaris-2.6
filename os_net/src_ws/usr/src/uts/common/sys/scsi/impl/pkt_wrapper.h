...
#pragma ident	"@(#)pkt_wrapper.h	1.37	96/06/07 SMI"
...
/* XXXPPC - this should really be an ifdef like, DMA_USES_PHYSADDR */
...
#endif	/* defined(i386) || defined(__i386) || defined(__ppc) */
