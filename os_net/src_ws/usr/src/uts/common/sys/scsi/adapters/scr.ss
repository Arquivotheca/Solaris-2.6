...
dataout_17:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[16])), WHEN DATA_OUT
dataout_16:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[15])), WHEN DATA_OUT
dataout_15:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[14])), WHEN DATA_OUT
dataout_14:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[13])), WHEN DATA_OUT
dataout_13:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[12])), WHEN DATA_OUT
dataout_12:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[11])), WHEN DATA_OUT
dataout_11:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[10])), WHEN DATA_OUT
dataout_10:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[9])), WHEN DATA_OUT
dataout_9:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[8])), WHEN DATA_OUT
dataout_8:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[7])), WHEN DATA_OUT
dataout_7:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[6])), WHEN DATA_OUT
dataout_6:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[5])), WHEN DATA_OUT
dataout_5:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[4])), WHEN DATA_OUT
dataout_4:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[3])), WHEN DATA_OUT
dataout_3:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[2])), WHEN DATA_OUT
dataout_2:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[1])), WHEN DATA_OUT
dataout_1:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[0])), WHEN DATA_OUT
do_list_end:
	MOVE 0 TO SCRATCHA0
	JUMP REL(switch)
...
datain_17:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[16])), WHEN DATA_IN
datain_16:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[15])), WHEN DATA_IN
datain_15:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[14])), WHEN DATA_IN
datain_14:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[13])), WHEN DATA_IN
datain_13:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[12])), WHEN DATA_IN
datain_12:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[11])), WHEN DATA_IN
datain_11:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[10])), WHEN DATA_IN
datain_10:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[9])), WHEN DATA_IN
datain_9:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[8])), WHEN DATA_IN
datain_8:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[7])), WHEN DATA_IN
datain_7:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[6])), WHEN DATA_IN
datain_6:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[5])), WHEN DATA_IN
datain_5:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[4])), WHEN DATA_IN
datain_4:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[3])), WHEN DATA_IN
datain_3:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[2])), WHEN DATA_IN
datain_2:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[1])), WHEN DATA_IN
datain_1:	MOVE FROM PASS(NTOFFSET(nt_curdp.nd_data[0])), WHEN DATA_IN
di_list_end:
	MOVE 0 TO SCRATCHA0
	JUMP REL(switch)
