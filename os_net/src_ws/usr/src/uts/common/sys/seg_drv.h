...
#pragma ident	"@(#)seg_drv.h	1.3	92/07/14 SMI"
 ...
 *	u_int	len;		length provided to mmap(2)
 *	u_int	prot;		requested access from <sys/mman.h>
 *	u_int	maxprot;	maximum protection
 *	u_int	flags;		flags provided to mmap(2)
