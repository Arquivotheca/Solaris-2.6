...
#pragma ident	"@(#)dlpi.h	1.18	96/09/27 SMI"	/* SVr4.0 1.2	*/
 ...
 */
extern void	dlbindack(queue_t *, mblk_t *, long, void *, ulong,
		    ulong, ulong);
extern void	dlokack(queue_t *, mblk_t *, ulong);
extern void	dlerrorack(queue_t *, mblk_t *, ulong, ulong, ulong);
extern void	dluderrorind(queue_t *, mblk_t *, void *, ulong,
		    ulong, ulong);
extern void	dlphysaddrack(queue_t *, mblk_t *, void *, ulong);
#endif	/* _KERNEL */
