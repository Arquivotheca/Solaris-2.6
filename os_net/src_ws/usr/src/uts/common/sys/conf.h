...
#pragma ident	"@(#)conf.h	1.44	96/09/27 SMI"	/* SVr4.0 11.21	*/
...
extern int cdev_segmap(dev_t, off_t, struct as *, caddr_t *,
    off_t, u_int, u_int, u_int, cred_t *);
...
/*
 * Flags to support different type models.  See <sys/model.h>
 */
#define	D_MODELS	DATAMODEL_MASK	/* Note: 0x0FF00000 */
#define	D_ILP32		DATAMODEL_ILP32
#define	D_LP64		DATAMODEL_LP64
#define	D_NATIVE	DATAMODEL_NATIVE

/*
 * DRV_CAPABLE determines if a driver can handle a certain originating model.
 */
#define	DRV_CAPABLE(cbp, model) \
	(((cbp)->cb_flag | D_NATIVE) & (model) == (model))
