...
#pragma ident	"@(#)kbd.h	1.31	95/08/07 SMI"	/* SunOS4.0 1.18 */
...
#if	defined(prep)
#define	KBD_PRESSED_PREFIX	0x01	/* prefix for key press */
#define	KBD_RELEASED_PREFIX	0x02	/* prefix for key release */
#define	PRESSED		0x0000		/* 0x0100 bit off: key was pressed */
#define	RELEASED	0x0100		/* 0x0100 bit on : key was released */
#else
...
#if	defined(prep)
/*
 * Really only needed 134 for Japanese, but 136 makes the table end on a
 * line boundary.
 */
