...
{								\
	...
	if (tnf_v_probe_test) {					\
		...
		if (tnf_v_probe_buffer) {			\
			...
			(tnf_reference_t) &(tnf_v_probe_buffer->data_1)); \
		    (tnf_v_probe_p->probe_func)(&tnf_v_set_p);	\
		}						\
	}							\
}
...
{								\
	...
	if (tnf_v_probe_test) {					\
		...
		if (tnf_v_probe_buffer) {			\
			...
			(tnf_reference_t) &(tnf_v_probe_buffer->data_2)); \
		    (tnf_v_probe_p->probe_func)(&tnf_v_set_p);	\
		}						\
	}							\
}
...
{								\
	...
	if (tnf_v_probe_test) {					\
		...
		if (tnf_v_probe_buffer) {			\
			...
			(tnf_reference_t) &(tnf_v_probe_buffer->data_3)); \
		    (tnf_v_probe_p->probe_func)(&tnf_v_set_p);	\
		}						\
	}							\
}
...
{								\
	...
	if (tnf_v_probe_test) {					\
		...
		if (tnf_v_probe_buffer) {			\
			...
			(tnf_reference_t) &(tnf_v_probe_buffer->data_4)); \
		    (tnf_v_probe_p->probe_func)(&tnf_v_set_p);	\
		}						\
	}							\
}
...
{								\
	...
	if (tnf_v_probe_test) {					\
		...
		if (tnf_v_probe_buffer) {			\
			...
			(tnf_reference_t) &(tnf_v_probe_buffer->data_5)); \
		    (tnf_v_probe_p->probe_func)(&tnf_v_set_p);	\
		}						\
	}							\
}
