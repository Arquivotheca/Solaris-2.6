...
#pragma ident	"@(#)gld.h	1.10	96/05/27 SMI"
...
struct gld_mac_info {
	...
	kmutex_t	NOgldm_intrlock;	/* UNUSED */
	...
	int		(*NOgldm_inform)();	/* inform driver of event */
						/* (for PCMCIA) */
	/* UNUSED */
} gld_mac_info_t;
...
#define	gld_boardid(nvm) (*(ushort *)(gldnvm(nvm)->boardid))
