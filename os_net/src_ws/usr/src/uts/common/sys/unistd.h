...
#pragma ident	"@(#)unistd.h	1.29	96/06/05 SMI"	/* From SVR4.0 1.3 */
...
/* PPC specific names */
#define	_SC_PPC_GRANULE_SZ	601	/* Granule size for reservations */
#define	_SC_PPC_TB_TICKSPSECH	602	/* See below */
#define	_SC_PPC_TB_TICKSPSECL	603	/* Time Base rate */
