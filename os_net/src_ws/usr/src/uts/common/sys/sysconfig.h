...
#pragma ident	"@(#)sysconfig.h	1.18	95/08/03 SMI"	/* SVr4.0 1.5 */
...
#define	_CONFIG_PPC_GRANULE_SZ	39	/* reservation size bytes ppc only */
#define	_CONFIG_PPC_TB_RATEH	40	/* ppc only */
#define	_CONFIG_PPC_TB_RATEL	41	/* ppc only */
