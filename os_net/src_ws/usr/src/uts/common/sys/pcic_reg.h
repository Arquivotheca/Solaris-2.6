...
#pragma ident	"@(#)pcic_reg.h	1.13	96/08/26 SMI"
...
#define	PCIC_IOCL_OFFSET_LOW	0x36 /* I/O Offset for CL */
#define	PCIC_IOCL_OFFSET_HI	0x37
#define	PCIC_IOCL_OFFSET_OFFSET	2
...
#define	SYSMEM_CLTIMER_SET_1	0x40
...
#define	CARDMEM_LOW(x)		(((u_long)(x)>>12)&0xFF)
#define	CARDMEM_HIGH(x)		(((u_long)(x)>>20)&0x3F)
...
#define	HIGH_BYTE(x)	(u_char)((((ushort)(x)) >> 8) & 0xFF)
#define	LOW_BYTE(x)	(u_char)(((ushort)(x)) & 0xFF)
...
#define	IOMEM_CLTIMER_SET_1	0x04	/* CL timer set selection */
