...
#pragma ident	"@(#)sunddi.h	1.71	96/10/15 SMI"
...
#if defined(i386) || defined(__i386) || defined(__ppc)
...
int
devmap_load(devmap_cookie_t dhp, offset_t offset, size_t len, u_int type,
	u_int rw);
...
devmap_devmem_setup(devmap_cookie_t dhp, dev_info_t *dip,
	struct devmap_callback_ctl *callback_ops, u_int rnumber,
	offset_t roff, size_t len, u_int maxprot, u_int flags,
...
int
ddi_dma_sync(ddi_dma_handle_t handle, off_t offset, size_t len, u_int flags);
...
uint_t	ddi_model_convert_from(uint_t);
...
int
ddi_devid_init(dev_info_t *dip, u_short devid_type, u_short nbytes,
