...
#pragma ident	"@(#)seg.h	1.49	96/08/14 SMI"
...
struct seg {
	...
	struct	seg_ops {
		...
		int	(*pagelock)(struct seg *, caddr_t, u_int,
...
extern	void	seg_pupdate(void *);
extern	void	seg_ppurge(struct seg *);
extern	void	seg_pinactive(struct seg *, caddr_t, u_int, struct page **,
			enum seg_rw, void (*)());
extern	void	seg_pinsert(struct seg *, caddr_t, u_int, struct page **,
			enum seg_rw, void (*)());
extern	struct	page **seg_plookup(struct seg *, caddr_t,
			u_int, enum seg_rw);
