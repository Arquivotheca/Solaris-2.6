...
#pragma ident	"@(#)seg_map.h	1.40	96/04/19 SMI"
...
struct segmap_crargs {
	u_int	prot;
	u_int	shmsize;	/* shm_alignment for VAC, 0 for PAC. */
	u_int	nfreelist;	/* number of freelist per color, >= 1 */
};
...
struct	smfree {
	...
	u_short		sm_want;	/* someone wants a slot of this color */
