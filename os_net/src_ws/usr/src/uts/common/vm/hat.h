...
#pragma ident	"@(#)hat.h	1.74	96/06/14 SMI"
...
int	hat_dup(struct hat *, struct hat *, caddr_t, size_t, u_int);
 ...
 *
 * u_int hat_getattr(hat, addr, *attr)
 ...
 *
 * u_long hat_getpfnum(hat, addr)
 *	returns pfn for <hat, addr> or -1 if mapping is invalid.
 *
 * u_long hat_getkpfnum(addr)
 *	returns pfn for addr in kernel address space
 *	or -1 if mapping is invalid.
 *
...
void	hat_memload(struct hat *, caddr_t, struct page *, u_int, u_int);
void	hat_memload_array(struct hat *, caddr_t, size_t, struct page **,
		u_int, u_int);

void	hat_devload(struct hat *, caddr_t, size_t, u_long, u_int, int);

void	hat_unlock(struct hat *, caddr_t, size_t);
void	hat_unload(struct hat *, caddr_t, size_t, u_int);
void	hat_sync(struct hat *, caddr_t, size_t, u_int);
void	hat_map(struct hat *, caddr_t, size_t, u_int);
void	hat_setattr(struct hat *, caddr_t, size_t, u_int);
void	hat_clrattr(struct hat *, caddr_t, size_t, u_int);
void	hat_chgattr(struct hat *, caddr_t, size_t, u_int);
u_int	hat_getattr(struct hat *, caddr_t, u_int *);
size_t	hat_getpagesize(struct hat *, caddr_t);
u_long	hat_getpfnum(struct hat *, caddr_t);
u_long	hat_getkpfnum(caddr_t);
...
void	hat_chgprot(struct hat *, caddr_t, size_t, u_int);
...
void	hat_page_setattr(struct page *, u_int);
void	hat_page_clrattr(struct page *, u_int);
u_int	hat_page_getattr(struct page *, u_int);
int	hat_pageunload(struct page *, u_int);
u_int	hat_pagesync(struct page *, u_int);
u_long	hat_page_getshare(struct page *);
faultcode_t hat_softlock(struct hat *, caddr_t, size_t *,
			struct page **, u_int);
faultcode_t hat_pageflip(struct hat *, caddr_t, caddr_t, size_t *,
			struct page **, struct page **);
...
void	hat_setstat(struct as *, caddr_t, size_t, u_int);
 ...
 *	HAT_LOAD_RELOAD	Reload a valid pte with a differen page frame.
 */
