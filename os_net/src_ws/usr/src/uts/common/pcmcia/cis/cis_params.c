...
#ident "@(#)cis_params.c	1.11	96/05/23 SMI"
 ...
 */
uint_t cistpl_devspeed_table[CISTPL_DEVSPEED_MAX_TBL] = {
    0,		/* 0x00 - DSPEED_NULL */
 ...
 */
uint_t cistpl_devspeed_man[CISTPL_DEVSPEED_MAX_MAN] = {
    0,		/* no units */
    10,		/* no units */
    12,		/* no units */
    13,		/* no units */
 ...
 */
uint_t cistpl_devspeed_exp[CISTPL_DEVSPEED_MAX_EXP] = {
    1,		/* 1 nS */
    10,		/* 10 nS */
    100,	/* 100 nS */
    1000,	/* 1000 nS */
 ...
 */
uint_t cistpl_cftable_io_size_table[] = {
	0,
	1,
	2,
	4,
...
uint_t cistpl_cftable_shift_table[] = {
	0,
	8,
	16,
	24,
