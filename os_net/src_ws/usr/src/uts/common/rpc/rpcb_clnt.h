...
#pragma ident	"@(#)rpcb_clnt.h	1.11	93/07/16 SMI"
...
#ifdef __STDC__
extern bool_t		rpcb_set(const u_long, const u_long, const struct
netconfig  *, const struct netbuf *);
extern bool_t		rpcb_unset(const u_long, const u_long, const struct
netconfig *);
extern rpcblist	*rpcb_getmaps(const struct netconfig *, const char *);
extern enum clnt_stat	rpcb_rmtcall(const struct netconfig *, const char *,
const u_long, const u_long, const u_long, const xdrproc_t, const caddr_t,
const xdrproc_t, const caddr_t, const struct timeval, const struct netbuf *);
extern bool_t		rpcb_getaddr(const u_long, const u_long, const struct
netconfig *, struct netbuf *, const  char *);
