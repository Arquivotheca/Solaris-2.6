/*
 * Copyright (c) 1986 - 1991, 1995, 1996 by Sun Microsystems, Inc.
 * All rights reserved.
 */
...
#pragma ident	"@(#)auth.h	1.35	96/05/03 SMI"
...
#ifdef _KERNEL
		int	(*ah_wrap)(struct __auth *, caddr_t, u_long,
