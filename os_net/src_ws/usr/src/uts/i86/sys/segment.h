...
#pragma ident	"@(#)segment.h	1.12	96/05/22 SMI"
...
#define	MKDSCR(base, limit, acc1, acc2) \
	{ (u_long)(base), \
	((u_long)(limit)|((u_char)(acc2)<<20)|((u_char)(acc1)<<24)) }
