...
#pragma ident	"@(#)promimpl.h	1.14	95/07/14 SMI"
...
extern	void *	impl_bus_nextnode(void *devid);
extern	void *	impl_bus_childnode(void *devid);
extern	int	impl_bus_getproplen(void *devid, caddr_t name);
extern	int	impl_bus_getprop(void *devid, caddr_t name, caddr_t value);
