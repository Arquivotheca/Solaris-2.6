...
#pragma ident	"@(#)bootconf.h	1.18	96/08/08 SMI"
...
struct bootops {
	 ...
	 */
	int (*bsys_getdents)(struct bootops *, int, struct dirent *, u_int);
	 ...
	 */
	caddr_t	(*bsys_ealloc)(struct bootops *, caddr_t virthint, u_int size,
		int align, int flags);
