...
#pragma ident "@(#)vc_dptbl.c	1.1	92/09/16 SMI"
 ...
 * vc_dptbl. The contents of this file should be included in the
 * vc_dptbl(4) man page with proper instructions for making
 * and replacing the VC_DPTBL.kmod in modules/sched. This was the
...
/*
 * array of global priorities used by vc procs sleeping or
 * running in kernel mode after sleep
 */

pri_t config_vc_kmdpris[] = {
...
pri_t vc_maxkmdpri = sizeof (config_vc_kmdpris) / sizeof (pri_t) - 1;
pri_t config_vc_maxumdpri = sizeof (config_vc_dptbl) / sizeof (vcdpent_t) - 1;

/*
 * Return the address of config_vc_dptbl
 */
vcdpent_t *
vc_getdptbl()
{
	return (config_vc_dptbl);
}

/*
 * Return the address of config_vc_kmdpris
 */
pri_t *
vc_getkmdpris()
{
	return (config_vc_kmdpris);
}

/*
 * Return the address of vc_maxumdpri
 */
pri_t
vc_getmaxumdpri()
{
	return (config_vc_maxumdpri);
}
