 ...
 * 	(c) 1983, 1984, 1985, 1986, 1987, 1988, 1989-1994  AT&T.
 *		All rights reserved.
 *
 */
...
#pragma ident	"@(#)seg_kmem.h	1.34	94/07/26 SMI"
...
extern struct seg E_kvseg;	/* kernel's "sptalloc" segment used by kobj */
 ...
 * optional array of spte's used to map the given segment.
 */
extern int segkmem_create(struct seg *, void *);

/*
 * Special kernel segment operations.
 */
