...
#pragma ident	"@(#)cram.h	1.2	94/09/03 SMI"
...
/*
 * cmos_lck must be locked when addressing CMOS
 */
lkinfo_t cmos_lockinfo;
lock_t  *cmos_lck;
#define	cmos_lock_init() \
	cmos_lck = LOCK_ALLOC(1, pldisk, &cmos_lockinfo, KM_NOSLEEP)
#define	cmos_lock(s)	LOCK(cmos_lck, (s))
#define	cmos_unlock(s)	UNLOCK(cmos_lck, (s))
