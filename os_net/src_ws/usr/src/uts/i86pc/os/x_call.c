...
#pragma ident	"@(#)x_call.c	1.20	95/09/19 SMI"
...
xc_init()
{
	 ...
	 */
	mutex_init(&xc_mbox_lock[0], "x_call mbox low",
		MUTEX_DRIVER, (void *)ipltospl(XC_LO_PIL));
	mutex_init(&xc_mbox_lock[1], "x_call mbox med",
		MUTEX_DRIVER, (void *)ipltospl(XC_MED_PIL));
	mutex_init(&xc_mbox_lock[2], "x_call mbox high",
		MUTEX_DRIVER, (void *)ipltospl(XC_HI_PIL));
#ifdef LATER
