 ...
 */
#pragma ident	"@(#)uppc_ml.s	1.7	96/10/17 SMI"
...
.CL3:
	...
	addl	%ecx,%eax
	sall	$1,%ecx
	addl	%ecx,%eax		/ %eax = %ecx * 0x340;
					/ 9 clocks against mul of 22 clocks.
					/ loss of accuracy < 2 % of 1/hz sec.

	cmpl	hrtime_base+4, %edx	/ has hrtime_base changed ?
	jne	.CL3
