...
#pragma ident	"@(#)envctrl.h	1.14	96/10/17 SMI"
...
#define	ENVCTRL_FSP_KEYOFF	0x00
#define	ENVCTRL_FSP_KEYON	0x40
#define	ENVCTRL_FSP_KEYDIAG	0x80
#define	ENVCTRL_FSP_KEYLOCKED	0xC0
...
typedef struct envctrl_fan {
	...
	u_int fanspeed;		/* chip to set speed of fans */
} envctrl_fan_t;
...
struct envctrl_pcd8584_regs {
	u_char s0;		/* Own Address S0' */
	u_char pad[3];		/* Padding XXX Will go away in FCS */
	u_char s1;		/* Control Status register */
	u_char pad1[3];
	u_char clock_s2;	/* Clock programming register */
};
#else
struct envctrl_pcd8584_regs {
	u_char s0;		/* Own Address S0' */
...
struct envctrl_pcf8591_chip {
	u_char chip_num;		/* valid values are 0-7 */
	int type;			/* type is PCF8591 */
	u_char	sensor_num;		/* AIN0, AIN1, AIN2 AIN3 */
	u_char	temp_val;		/* value of temp probe */
};
...
#define	PS1	PCF8574A_BASE_ADDR | ENVCTRL_PCF8574_DEV1
#define	PS2	PCF8574A_BASE_ADDR | ENVCTRL_PCF8574_DEV2
#define	PS3	PCF8574A_BASE_ADDR | ENVCTRL_PCF8574_DEV3
...
#define	ENVCTRL_DFLOP_INIT0	0x70
#define	ENVCTRL_DFLOP_INIT1	0x78

#define	ENVCTRL_DEVINTR_INTI0	0xf0
...
struct envctrl_tda8444t_chip {
	...
	u_char	fan_num;		/* Ao0-Ao7 */
	u_char	val;			/* for fan speed */
};
...
110,	107,	105,	103,	100,	95,	90,	87,	/* 8-15 */
85,	83,	81,	80,	78,	77,	76,	74,	/* 16-23 */
73,	71,	70,	69,	68,	67,	66,	65,	/* 24-31 */
64,	63,	62,	61,	60,	60,	59,	58,	/* 32-39 */
57,	57,	56,	55,	55,	54,	53,	53,	/* 40-47 */
52,	51,	50,	50,	50,	49,	49,	48,	/* 48-55 */
48,	47,	47,	46,	46,	45,	45,	44,	/* 56-63 */
44,	43,	42,	42,	41,	41,	40,	40,	/* 64-71 */
39,	39,	38,	38,	37,	37,	37,	37,	/* 72-79 */
36,	36,	35,	35,	35,	34,	34,	34,	/* 80-87 */
33,	33,	33,	32,	32,	32,	31,	31,	/* 88-95 */
30,	30,	30,	29,	29,	29,	29,	28,	/* 96-103 */
28,	28,	27,	27,	27,	26,	26,	26,	/* 104-111 */
25,	25,	25,	24,	24,	24,	24,	23,	/* 112-119 */
23,	23,	23,	22,	22,	22,	22,	21,	/* 120-127 */
21,	21,	20,	20,	20,	19,	19,	19,	/* 128-135 */
19,	19,	18,	18,	18,	18,	17,	17,	/* 136-143 */
17,	17,	16,	16,	16,	16,	15,	15,	/* 144-151 */
15,	15,	15,	14,	14,	14,	14,	13,	/* 142-159 */
13,	13,	13,	12,	12,	12,	12,	12,	/* 160-167 */
11,	11,	11,	11,	10,	10,	10,	10,	/* 168-175 */
10,	10,	9,	9,	9,	9,	8,	8,	/* 176-183 */
8,	8,	7,	7,	7,	7,	7,	6,	/* 184-191 */
6,	6,	6,	6,	5,	5,	5,	5,	/* 192-199 */
5,	4,	4,	4,	4,	4,	3,	3,	/* 200-207 */
3,	3,	3,	2,	2,	2,	2,	2,	/* 208-215 */
1,	1,	1,	1,	1,	0,	0,	0,	/* 216-223 */
0,	-1,	-1,	-1,	-1,	-2,	-2,	-2,	/* 224-231 */
-2,	-3,	-3,	-3,	-3,	-4,	-4,	-4,	/* 232-239 */
-4,	-5,	-5,	-5,	-5,	-6,	-6,	-6,	/* 240-247 */
-6,	-7,	-7,	-7,	-7,	-8,	-8,	-8,	/* 248-255 */
-8,								/* 256 */
};
#endif OLD
#endif lint
...
struct envctrlunit {
	...
	ulong_t num_fans_present;
	ulong_t num_ps_present;
	ulong_t num_encl_present;
	ulong_t num_cpus_present;
	kstat_t *psksp;
	kstat_t *fanksp;
	kstat_t *enclksp;
...
#define	ENVCTRL_IOC_RESETTMPR	(int)(_IOW('p', 76, u_char))
#define	ENVCTRL_IOC_SETMODE	(int)(_IOW('p', 77, u_char))
#define	ENVCTRL_IOC_SETTEMP	(int)(_IOW('p', 79, u_char))
#define	ENVCTRL_IOC_SETFAN (int)(_IOW('p', 80, struct envctrl_tda8444t_chip))
#define	ENVCTRL_IOC_SETWDT	(int)(_IOW('p', 81, u_char))
...
#define	ENVCTRL_IOC_SETFSP	(int)(_IOW('p', 84, u_char))
