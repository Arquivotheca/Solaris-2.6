...
#pragma ident  "@(#)sudev.h 1.3     95/09/18 SMI"
...
#ifdef SU_DRIVER
#define	OUTB(ignore, offset, value) ddi_putb(asy->asy_handle, \
					asy->asy_ioaddr+offset, value)
#define	INB(ignore, offset) \
	ddi_getb(asy->asy_handle, asy->asy_ioaddr+offset)
#else SU_DRIVER
...
struct asycom {
	...
	u_char *	asy_ioaddr;	/* i/o address of ASY port */
