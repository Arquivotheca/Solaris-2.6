...
#pragma ident	"@(#)prom_plat.h	1.21	96/07/23 SMI"
...
extern	caddr_t		prom_map(caddr_t virthint,
			    unsigned long long physaddr, u_int size);
...
extern	int		prom_claim_phys(u_int size,
			    unsigned long long physaddr);
extern	void		prom_free_phys(u_int size,
			    unsigned long long physaddr);
