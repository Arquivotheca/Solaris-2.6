...
#pragma ident	"@(#)keyboard.h	1.7	92/07/14 SMI"

/*
 * XXX - The following gross conditional allows this file to be included
 *	 after sys/kbd.h. These files define similar data. This is important
 *	 because sun4c/sys/eeprom.h includes sun4c/sys/mon/eeprom.h which
 *	 includes this file. This needs to be fixed. This should probably
 *	 be fixed by removing the include of this file from sys/mon/eeprom.h
 *	 and fixing the utilities which break.
 */
