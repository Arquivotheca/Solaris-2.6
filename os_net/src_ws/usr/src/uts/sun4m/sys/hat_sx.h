...
#pragma ident	"@(#)hat_sx.h	1.12	94/03/28 SMI"
...
#define	SX_HMEBLK_HASH(va)	((((u_int)(va) >> (u_int)SX_HMENT_BLKSHIFT) \
						% (SX_HMENT_NBUCKETS - 1)))
 ...
 */
extern void (*sx_mmu_unmap_callback)(struct as *, caddr_t, u_int);

extern void sx_mmu_add_vaddr(struct as *, caddr_t, caddr_t, u_int);
extern void sx_mmu_del_vaddr(struct as *, caddr_t, caddr_t, u_int, u_int);
