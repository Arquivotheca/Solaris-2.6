...
#pragma ident	"@(#)intreg.h	1.15	92/07/14 SMI"
...
#define	SIR_VMEINT(n)	(0x00000001 << (n-1))
#define	SIR_L1		0
#define	SIR_L2		(SIR_SBUSINT(1)+SIR_VMEINT(1))
#define	SIR_L3		(SIR_SBUSINT(2)+SIR_VMEINT(2))
#define	SIR_L4		(SIR_SCSI)
#define	SIR_L5		(SIR_SBUSINT(3)+SIR_VMEINT(3))
#define	SIR_L6		(SIR_ETHERNET)
#define	SIR_L7		(SIR_SBUSINT(4)+SIR_VMEINT(4))
#define	SIR_L8		(SIR_VIDEO)
#define	SIR_L9		(SIR_SBUSINT(5)+SIR_VMEINT(5)+SIR_MODULEINT)
#define	SIR_L10		(SIR_REALTIME)
#define	SIR_L11		(SIR_SBUSINT(6)+SIR_VMEINT(6)+SIR_FLOPPY)
