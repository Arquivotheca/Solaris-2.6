...
#pragma ident	"@(#)mp_implfuncs.c	1.14	96/06/28 SMI"
...
void psm_handle_memerror(paddr_t physaddr);
...
void
psm_handle_memerror(paddr_t physaddr)
{
	/*
	 ...
	 */
	cmn_err(CE_PANIC,
		"psm_handle_memerror: error reported at physaddr 0x%lx\n",
		physaddr);
}
