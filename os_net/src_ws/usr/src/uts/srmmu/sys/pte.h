...
#pragma ident	"@(#)pte.h	1.38	95/01/16 SMI"
...
#define	MMU_L1_INDEX(a)		((((u_int)(a)) & 0xFF000000) >> \
				    (MMU_STD_PAGESHIFT + MMU_STD_FIRSTSHIFT))
#define	MMU_L2_INDEX(a) 	((((u_int)(a)) & 0x00FC0000) >> \
				    (MMU_STD_PAGESHIFT + MMU_STD_SECONDSHIFT))
#define	MMU_L3_INDEX(a)		((((u_int)(a)) & 0x0003F000) >>  \
				    (MMU_STD_PAGESHIFT + MMU_STD_THIRDSHIFT))

#define	MMU_L1_BASE(a)		((caddr_t)(((u_int)(a)) & 0xFF000000))
#define	MMU_L2_BASE(a)		((caddr_t)(((u_int)(a)) & 0xFFFC0000))
#define	MMU_L3_BASE(a)		((caddr_t)(((u_int)(a)) & 0xFFFFF000))

#define	MMU_L1_OFF(a)		(((u_int)(a)) & 0x00FFFFFF)
#define	MMU_L2_OFF(a)		(((u_int)(a)) & 0x0003FFFF)
#define	MMU_L3_OFF(a)		(((u_int)(a)) & 0x00000FFF)
...
struct ptp {
	...
	u_int EntryType:2; /* Checked for validity */
};
