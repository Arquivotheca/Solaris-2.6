...
#pragma ident	"@(#)mmu.h	1.62	94/11/30 SMI"
...
extern unsigned int shm_alignment;	/* VAC address consistency modulus */
#endif /* _ASM */
...
#ifdef VAC
void	vac_init();
void	vac_usrflush(/* u_int flags */);
void	vac_ctxflush(/* int cxn, u_int flags */);
void	vac_rgnflush(/* caddr_t va, int cxn, u_int flags */);
void	vac_segflush(/* caddr_t va, int cxn, u_int flags */);
void	vac_pageflush(/* caddr_t va, int cxn, u_int flags */);
void	vac_flush(/* caddr_t va, int size */);
void	vac_allflush(/* u_int flags */);
...
extern void mmu_pdcflush_ctxt(u_int c_num);
...
extern void mmu_setctxreg(u_int c_num);
...
extern u_int mmu_probe(caddr_t probe_val, u_int *fsr);
extern void mmu_flush(u_int flush_val);
#endif /* !_ASM */
