...
#pragma ident	"@(#)avintr.c	1.19	94/11/22 SMI"	/* SVr4 */

/*
 * Autovectored Interrupt Configuration and Deconfiguration (tread carefully)
 */

#define	SUNDDI_IMPL	/* so we get the real spl* */
	...
	kmutex_t *mutex_p)
{
	 ...
	 * XXX	Warning: Rocket science mode ..
	 */
	levelp->av_devi = devi;
	levelp->av_mutex = mutex_p;
