...
#pragma ident	"@(#)traptrace.h	1.1	94/03/17 SMI"
 ...
 * the first word.
 */
#define	TRAP_ENT_TBR	0
#define	TRAP_ENT_PSR	4
#define	TRAP_ENT_PC	8
#define	TRAP_ENT_SP	0x0c
#define	TRAP_ENT_G7	0x10
#define	TRAP_ENT_TR	0x14		/* indicates how far into trap */
...
#else /* MP */
#define	TRACE_PTR(ptr, scr1)				\
	sethi	%hi(trap_trace_ctl), ptr; 	\
	ld	[ptr + %lo(trap_trace_ctl)], ptr
#endif /* MP */
