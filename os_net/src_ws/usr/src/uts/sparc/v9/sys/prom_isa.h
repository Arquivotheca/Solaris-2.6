...
#pragma ident	"@(#)prom_isa.h	1.6	96/07/23 SMI"
...
#define	p1275_phandle2cell(ph)	((cell_t)((unsigned)((phandle_t)(ph))))
#define	p1275_dnode2cell(d)	((cell_t)((unsigned)((dnode_t)(d))))
#define	p1275_ihandle2cell(ih)	((cell_t)((unsigned)((ihandle_t)(ih))))
