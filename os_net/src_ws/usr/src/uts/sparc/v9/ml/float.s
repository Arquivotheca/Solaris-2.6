...
#ident	"@(#)float.s	1.19	95/03/22 SMI"
...
int fpu_exists = 1;
	...
	.seg	".data"
	.global fpu_exists		! always exists for V9
fpu_exists:				! sundiag (gack) uses this variable
	.word	1			! assume we always use FPU
	.align	8
fsrholder:
...
{}
	...
	retl				! PSTATE_PEF always enabled in kernel
...
/* ARGSUSED */
void
_fp_read_pdreg(FPU_DREGS_TYPE *pd, unsigned n)
{}

/* ARGSUSED */
void
_fp_write_pdreg(FPU_DREGS_TYPE *pd, unsigned n)
{}
...
/* ARGSUSED */
void
_fp_write_fprs(unsigned fprs_val)
{}
