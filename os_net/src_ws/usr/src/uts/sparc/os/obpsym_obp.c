...
#pragma ident	"@(#)obpsym_obp.c	1.4	95/03/14 SMI"
 ...
 *
 * On early sun4c systems, you must type "ramforth" before booting to use
 * this module.  On 2.2 and later PROMS, you can add this to your nvramrc
 * script.  On 1.x PROMS, you must do a PROM reset and type in "ramforth".
 */
