...
#pragma ident	"@(#)dbri_mmcodec.c	1.47	96/05/24 SMI"
 ...
 */
	...
	mmdata.r.pio = (u_char)Dbri_mmcodec_pio;
	...
	mmctrl.r.mb = (u_char)Dbri_mmcodec_mb;
	mmctrl.r.pio = (u_char)Dbri_mmcodec_pio;
