...
#pragma ident	"@(#)dbri_pipe.c	1.14	96/04/22 SMI"
...
dbri_basepipe_init(dbri_unit_t	*unitp, dbri_chan_t dchan, int *error)
{
	...
	*error = 0;
	...
	case DBRI_PIPE_CHI:
		...
		pm_busy_component(unitp->dip, 2); /* Audio is now in use */
