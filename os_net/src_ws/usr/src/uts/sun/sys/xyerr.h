...
#pragma ident	"@(#)xyerr.h	1.9	93/03/10 SMI"
...
struct xyerror {
	...
	XYE_OK,   XY_ERTRY,	HDK_NONMEDIA,	"spurious error",
	XYE_NRDY, XY_ERBSY,	HDK_NONMEDIA,	"drive not ready",
	XYE_FECC, XY_ERCOR,	HDK_ISMEDIA,	"fixed ecc error",
	XYE_SRTY, XY_ERCOR,	HDK_NONMEDIA,	"seek retry",
	XYE_HDNF, XY_ERTRY,	HDK_ISMEDIA,	"header not found",
	XYE_HECC, XY_ERTRY,	HDK_ISMEDIA,	"hard ecc error",
	XYE_DFLT, XY_ERFLT,	HDK_NONMEDIA,	"drive fault",
	XYE_OPTO, XY_ERTRY,	HDK_NONMEDIA,	"operation timeout",
	XYE_DSEQ, XY_ERFLT,	HDK_NONMEDIA,	"disk sequencer error",
	XYE_MADR, XY_ERFTL,	HDK_NONMEDIA,	"memory addr error",
	XYE_HDER, XY_ERFLT,	HDK_ISMEDIA,	"cylinder & head header error",
	XYE_LINT, XY_ERHNG,	HDK_NONMEDIA,	"lost interrupt",
	XYE_ERR,  XY_ERFLT,	HDK_NONMEDIA,	"hard error",
	XYE_DERR, XY_ERFLT,	HDK_NONMEDIA,	"double hard error",
	XYE_PROT, XY_ERFTL,	HDK_NONMEDIA,	"write protect error",
	XYE_SEEK, XY_ERFLT,	HDK_NONMEDIA,	"drive seek error",
	XYE_SLIP, XY_ERFTL,	HDK_NONMEDIA,	"sector slip error",
	XYE_2SML, XY_ERFTL,	HDK_NONMEDIA,	"last sector too small",
	XYE_SSIZ, XY_ERFTL,	HDK_NONMEDIA,	"illegal sector size",
	XYE_IPND, XY_ERFTL,	HDK_NONMEDIA,	"interrupt pending",
	XYE_BCON, XY_ERFTL,	HDK_NONMEDIA,	"busy conflict",
	XYE_CADR, XY_ERFTL,	HDK_NONMEDIA,	"cylinder addr error",
	XYE_SADR, XY_ERFTL,	HDK_NONMEDIA,	"sector addr error",
	XYE_ILLC, XY_ERFTL,	HDK_NONMEDIA,	"unimplemented command",
	XYE_0CNT, XY_ERFTL,	HDK_NONMEDIA,	"zero sector count",
	XYE_TSTA, XY_ERFTL,	HDK_NONMEDIA,	"self test error a",
	XYE_TSTB, XY_ERFTL,	HDK_NONMEDIA,	"self test error b",
	XYE_TSTC, XY_ERFTL,	HDK_NONMEDIA,	"self test error c",
	XYE_SECC, XY_ERFTL,	HDK_ISMEDIA,	"soft ecc error",
	XYE_HADR, XY_ERFTL,	HDK_NONMEDIA,	"head addr error",
	XYE_UNKN, XY_ERFTL,	HDK_NONMEDIA,	"unknown error",
};
