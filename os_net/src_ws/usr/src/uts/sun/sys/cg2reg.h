...
#ifndef _SYS_CG2REG_H
#define	_SYS_CG2REG_H

#pragma ident	"@(#)cg2reg.h	1.17	92/07/14 SMI"	/* SunOS-4.1.2 1.11 */
...
struct	cg2memfb {
	union bitplane memplane[8];	/* word mode memory */
	union byteplane pixplane;	/* pixel mode memory */
};
