...
#pragma ident	"@(#)comvec.h	1.9	95/03/23 SMI"
...
struct romvec_obp {
	...
	caddr_t (*op2_alloc)(/* caddr_t virthint, u_int size */);
					/* Allocate physical memory */

	void    (*op2_free)(/* caddr_t virthint, u_int size */);
					/* Deallocate physical memory */

	caddr_t (*op2_map)(/* caddr_t virthint, u_int space, u_int phys,
	    u_int size */);		/* Create device mapping */

	void    (*op2_unmap)(/* caddr_t virt, u_int size */);
...
#endif	/* _KERNEL */
	u_int	(*op2_close)(/* int ihandle */);

	int (*op2_read)(/* int ihandle, caddr_t buf, u_int len */);
	int (*op2_write)(/* int ihandle, caddr_t buf, u_int len */);
	int (*op2_seek)(/* int ihandle, u_int offsh, u_int offsl */);

	void    (*op2_chain)(/* caddr_t virt, u_int size, caddr_t entry,
	    caddr_t argaddr, u_int arglen */);

	void    (*op2_release)(/* caddr_t virt, u_int size */);

	/*
	 * End V2 stuff
	 */

	caddr_t	(*op3_alloc)(/* caddr_t virthint, u_int size, int align */);
