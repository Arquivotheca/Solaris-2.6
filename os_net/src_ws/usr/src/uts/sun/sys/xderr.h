...
#pragma ident	"@(#)xderr.h	1.6	93/03/10 SMI"	/* SunOS 4.1.1 1.6 */
...
/*
 * Leave the following data visible- user level format programs depend on it.
 */
/*
...
XDE_OK,		XD_ERCOR,	HDK_NONMEDIA,	"spurious error",
XDE_NRDY,	XD_ERBSY,	HDK_NONMEDIA,	"drive not ready",
XDE_FECC,	XD_ERCOR,	HDK_ISMEDIA,	 "soft ecc corrected",
XDE_SRTY,	XD_ERCOR,	HDK_NONMEDIA,	"seek retry",
XDE_SFTR,	XD_ERCOR,	HDK_NONMEDIA,	"soft retry",
XDE_HECC,	XD_ERTRY,	HDK_ISMEDIA,	 "hard data ecc",
XDE_HDNF,	XD_ERTRY,	HDK_ISMEDIA,	 "header not found",
XDE_OPTO,	XD_ERTRY,	HDK_NONMEDIA,	"operation timeout",
XDE_DMAT,	XD_ERTRY,	HDK_NONMEDIA,	"vmedma timeout",
XDE_DSEQ,	XD_ERFLT,	HDK_NONMEDIA,	"disk sequencer error",
XDE_BPER,	XD_ERTRY,	HDK_NONMEDIA,	"fifo parity error",
XDE_HDEC,	XD_ERTRY,	HDK_ISMEDIA,	 "header ecc error",
XDE_FDMA,	XD_ERTRY,	HDK_NONMEDIA,	"fatal vmedma error",
XDE_VMEB,	XD_ERTRY,	HDK_NONMEDIA,	"vmebus error",
XDE_DPBY,	XD_ERBSY,	HDK_NONMEDIA,	"dual port busy",
XDE_DFLT,	XD_ERFLT,	HDK_NONMEDIA,	"drive faulted",
XDE_CHER,	XD_ERFLT,	HDK_ISMEDIA,	 "cylinder header error",
XDE_HHER,	XD_ERFLT,	HDK_ISMEDIA,	 "head header error",
XDE_OFCL,	XD_ERFLT,	HDK_NONMEDIA,	"drive not on cylinder",
XDE_SEEK,	XD_ERFLT,	HDK_NONMEDIA,	"drive seek error",
XDE_LINT,	XD_ERHNG,	HDK_NONMEDIA,	"lost interrupt",

XDE_FERR,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error",
XDE_FIST,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: iram self test",
XDE_FMT3,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: test 3",
XDE_FMT4,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: test 4",
XDE_FMT5,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: test 5",
XDE_FMT6,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: test 6",
XDE_FMT7,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: test 7",
XDE_FMT8,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: test 8",
XDE_FCKS,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: iopb checksum",
XDE_FIDF,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: iopb dma",
XDE_FALN,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: iopb addr align",
XDE_FFWR,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: firmware error",
XDE_FIMT,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: illegal test",
XDE_FACF,	XD_ERFLT,	HDK_NONMEDIA,	"fatal error: acfail asserted",
XDE_PROT,	XD_ERFTL,	HDK_NONMEDIA,	"write protect error",
XDE_ILLC,	XD_ERFTL,	HDK_NONMEDIA,	"unimplemented command",
XDE_0CNT,	XD_ERFTL,	HDK_NONMEDIA,	"zero sector count",
XDE_SSIZ,	XD_ERFTL,	HDK_NONMEDIA,	"illegal sector size",
XDE_FIRM,	XD_ERFTL,	HDK_NONMEDIA,	"firmware failure",
XDE_CADR,	XD_ERFTL,	HDK_NONMEDIA,	"cylinder addr error",
XDE_HADR,	XD_ERFTL,	HDK_NONMEDIA,	"head addr error",
XDE_SADR,	XD_ERFTL,	HDK_NONMEDIA,	"sector addr error",
XDE_IFL1,	XD_ERFTL,	HDK_NONMEDIA,	"illegal field length 1",
XDE_IFL2,	XD_ERFTL,	HDK_NONMEDIA,	"illegal field length 2",
XDE_IFL3,	XD_ERFTL,	HDK_NONMEDIA,	"illegal field length 3",
XDE_IFL4,	XD_ERFTL,	HDK_NONMEDIA,	"illegal field length 4",
XDE_IFL5,	XD_ERFTL,	HDK_NONMEDIA,	"illegal field length 5",
XDE_IFL6,	XD_ERFTL,	HDK_NONMEDIA,	"illegal field length 6",
XDE_IFL7,	XD_ERFTL,	HDK_NONMEDIA,	"illegal field length 7",
XDE_ISGL,	XD_ERFTL,	HDK_NONMEDIA,	"illegal scatter/gather length",
XDE_NSEC,	XD_ERFTL,	HDK_NONMEDIA,	"not enough sectors/track",
XDE_ALGN,	XD_ERFTL,	HDK_NONMEDIA,	"iopb alignment error",
XDE_SECC,	XD_ERFTL,	HDK_ISMEDIA,	 "soft ecc error",
XDE_IRAM,	XD_ERFTL,	HDK_NONMEDIA,	"iram checksum error",
XDE_ECCI,	XD_ERFTL,	HDK_ISMEDIA,	 "ecc error ignored",
XDE_SFMF,	XD_ERCOR,	HDK_NONMEDIA,	"set format field 5,	5A",
XDE_SGAA,	XD_ERFTL,	HDK_NONMEDIA,	"scatter/gather addr alignment",
XDE_SGAE,	XD_ERFTL,	HDK_NONMEDIA,	"scatter/gather with auto ecc",
XDE_HOLE,	XD_ERFTL,	HDK_NONMEDIA,	"illegal black hole address",
XDE_UNKN,	XD_ERFTL,	HDK_NONMEDIA,	"unknown error",
