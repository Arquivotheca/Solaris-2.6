...
#pragma ident	"@(#)aflt.h	1.4	93/05/01 SMI"
...
struct ecc_handler_args {
	u_int e_uncorrectable;	/* true if uncorrectable error */
	u_int e_addrhi;		/* most significant bits of address */
	u_int e_addrlo;		/* least significant bits of address */
};
