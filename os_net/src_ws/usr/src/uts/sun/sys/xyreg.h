...
#pragma ident	"@(#)xyreg.h	1.30	93/02/04 SMI"	/* From 4.1.1 1.23 */

/*
 * Xylogics 450/451 Disk Controller declarations
 */
...
#define	xy_status xy_nsect	/* low byte is status */
	...
	/* FOR CPU ONLY */
	struct xyiopb *xy_nxtaddr;	/* FOR CPU *ONLY*, next iopb */
};
...
#define	XYUNPERC	2		/* max # of units per controller */
