...
#pragma ident	"@(#)memreg.h	1.22	92/07/14 SMI"	/* SunOS4.1.2 1.16 */
...
#define	mrc_enable(mrc)		((mrc)->mrc_shift |= (u_short)0x100)
#define	mrc_disable(mrc)	((mrc)->mrc_shift &= ~(u_short)0x100)
