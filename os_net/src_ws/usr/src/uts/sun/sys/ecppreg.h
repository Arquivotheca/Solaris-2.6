...
#pragma ident	"@(#)ecppreg.h	2.5	96/09/24 SMI"
...
struct cheerio_dma_reg {
	ulong_t csr;	/* Data Control Status Register */
	ulong_t acr;	/* DMA Address Count Registers */
	ulong_t bcr;	/* DMA Byte Count Register */
};
