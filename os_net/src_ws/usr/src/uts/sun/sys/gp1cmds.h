...
#ifndef _SYS_GP1CMDS_H
#define	_SYS_GP1CMDS_H

#pragma ident	"@(#)gp1cmds.h	1.8	93/11/01 SMI"	/* SunOS4.0 1.28 */
...
#define	GP2_RGB_COLOR_TRIPLE	1	/* For GP1_SET_DEPTH_CUE_COLORS */
...
#define	gp1_pw_offset_X(p) \
	(gp1_d((p)->pw_clipdata->pwcd_prmulti)->cgpr_offset.x)
#define	gp1_pw_offset_Y(p) \
	(gp1_d((p)->pw_clipdata->pwcd_prmulti)->cgpr_offset.y)

#ifdef	__cplusplus
}
#endif

#endif	/* _SYS_GP1CMDS_H */
