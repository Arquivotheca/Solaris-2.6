...
#pragma ident	"@(#)fc_transport.h	1.12	96/07/30 SMI"
 ...
 */
#define	FC_STATUS_LOGIN_TIMEOUT		0x80000001
#define	FC_STATUS_CQFULL		0x80000002
#define	FC_STATUS_TRANSFAIL		0x80000003
#define	FC_STATUS_RESETFAIL		0x80000004
