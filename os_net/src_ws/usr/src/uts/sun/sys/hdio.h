...
#pragma ident	"@(#)hdio.h	1.5	92/07/14 SMI"
 ...
 */
struct hdk_cmd {
	u_short	hdkc_cmd;		/* command to be executed */
	...
	u_int	hdkc_buflen;		/* size of user's buffer */
};
...
struct hdk_log {
	...
	u_long	hdkl_count;		/* number of failures */
