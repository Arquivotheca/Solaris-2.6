...
#pragma ident	"@(#)espvar.h	1.74	96/10/16 SMI"
...
#define	IMSGSIZE	8
	 ...
	 */
	u_char		e_target_scsi_options_defined;
	int		e_scsi_options;
...
_NOTE(MUTEX_PROTECTS_DATA(esp::e_startQ_mutex,
	esp::e_startf esp::e_startb))
