...
#pragma ident	"@(#)fasvar.h	1.32	96/10/22 SMI"
...
struct fas {
	...
	u_char	f_polled_intr;	/* current interrupt was polled. */
...
#define	IMSGSIZE	8
	...
	u_int			f_reserved[256];

	u_int			f_reg_reads;
	u_int			f_reg_dma_reads;
	u_int			f_reg_writes;
	u_int			f_reg_dma_writes;
	u_int			f_reg_cmds;
	u_int			f_total_cmds;
#endif
	/*
