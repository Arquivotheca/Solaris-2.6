...
#pragma ident	"@(#)plnvar.h	1.24	96/10/17 SMI"
...
#define	PLN_TGT_PRIV_LEN	8	/* # of bytes in tgt private, default */
...
struct pln_scsi_cmd {
	...
	u_char		cmd_tgtprivate[PLN_TGT_PRIV_LEN];
...
#define	pln_iblock		pln_fc_tran->fc_iblock
	...
	long		pln_locator;		/* Locate position */
