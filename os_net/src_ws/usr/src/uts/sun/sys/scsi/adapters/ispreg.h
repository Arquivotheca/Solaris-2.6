...
#pragma ident	"@(#)ispreg.h	1.14	96/07/26 SMI"
...
struct isp_biu_regs {
	 ...
	 */
	u_short	isp_bus_id_lo;		/* R:    Hardwired Bus ID, Low */
	u_short	isp_bus_id_hi;		/* R:    Hardwired Bus ID, High */
	u_short	isp_bus_conf0;		/* R:    Bus Configuration #0 */
	u_short	isp_bus_conf1;		/* RW:   Bus Configuration #1 */
	u_short	isp_bus_icr;		/* RW:   Bus Interface Control */
	u_short	isp_bus_isr;		/* R:    Bus Interface Status */
	u_short	isp_bus_sema;		/* RW:   Bus Semaphore */
	u_short	isp_pci_nvram;		/* RW:   PCI NVRAM */
	u_short	gap0[0x8];
	...
	u_short	isp_cdma_addr0;		/* R(W): DMA Address, Word 0 */
	u_short	isp_cdma_addr1;		/* R(W): DMA Address, Word 1 */
	u_short	isp_pci_cdma_addr2;	/* R(W): DMA Address, Word 2 */
	u_short	isp_pci_cdma_addr3;	/* R(W): DMA Address, Word 3 */
	u_short	gap1[0x6];
	...
	u_short	isp_dma_addr0;		/* R(W): DMA Address, Word 0 */
	u_short	isp_dma_addr1;		/* R(W): DMA Address, Word 1 */
	u_short	isp_pci_dma_addr2;	/* R(W): DMA Address, Word 2 */
	u_short	isp_pci_dma_addr3;	/* R(W): DMA Address, Word 3 */
	u_short	gap2[0x6];
...
struct isp_mbox_regs {
	...
	u_short	isp_mailbox5;		/* R: Data from ISP */
					/* W: Data to ISP */
	u_short	isp_pci_mailbox6;	/* R: Data from ISP */
					/* W: Data to ISP */
	u_short	isp_pci_mailbox7;	/* R: Data from ISP */
					/* W: Data to ISP */
};
...
struct isp_sxp_regs {
	...
	u_short	isp_sxp_buf_word_tran;	/* R(W): SCSI Buffer Word Translate */
...
#define	ISP_PCI_REG_NUMBER	1	/* Access registers in PCI I/O    */
