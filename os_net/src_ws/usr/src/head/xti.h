...
#pragma ident	"@(#)xti.h	1.2	96/10/14 SMI"
...
struct t_info {
	...
	long options;	/* max size of protocol options			*/
	long tsdu;	/* max size of max transport service data unit	*/
	long etsdu;	/* max size of max expedited tsdu		*/
	...
	long flags;	/* other info about transport providers		*/
};
...
struct t_opthdr {
	...
	unsigned long level;	/* protocol level */
