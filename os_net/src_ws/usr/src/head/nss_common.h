...
#pragma ident	"@(#)nss_common.h	1.9	94/11/22 SMI"
 ...
 *
 * Backend routines return one of four status codes to the switch engine:
 * SUCCESS, UNAVAIL, NOTFOUND or TRYAGAIN (these are the same codes that may
