...
#pragma ident	"@(#)nislib.h	1.22	96/05/22 SMI"
...
nis_error __nis_CacheLocalInit(u_long *exp_time);
u_long __nis_CacheLocalLoadPref();
...
u_long __nis_CacheMgrTimers();
u_long __nis_CacheMgrRefreshCache();
u_long __nis_serverRefreshCache();
...
nis_error __nis_ping_servers(nis_bound_directory *binding, int max_rank);
