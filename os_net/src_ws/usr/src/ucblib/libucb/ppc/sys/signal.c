...
#pragma ident "@(#)signal.c 1.3	96/10/15 SMI"
/*******************************************************************
	...
	ucontext_t *ucp;
{
	...
	sc.sc_r1 = (int) ucp->uc_mcontext.gregs[R_R1];
	sc.sc_pc = (int) ucp->uc_mcontext.gregs[R_PC];
	sc.sc_cr = (int) ucp->uc_mcontext.gregs[R_CR];
	sc.sc_r2 = (int) ucp->uc_mcontext.gregs[R_R2];
	sc.sc_r3 = (int) ucp->uc_mcontext.gregs[R_R3];
	...
	ucp->uc_mcontext.gregs[R_R1] = (int) sc.sc_r1;
	ucp->uc_mcontext.gregs[R_PC] = (int) sc.sc_pc;
	ucp->uc_mcontext.gregs[R_CR] = (int) sc.sc_cr;
	ucp->uc_mcontext.gregs[R_R2] = (int) sc.sc_r2;
	ucp->uc_mcontext.gregs[R_R3] = (int) sc.sc_r3;
