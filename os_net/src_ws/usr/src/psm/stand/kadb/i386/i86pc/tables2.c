...
#ident "@(#)tables2.c	1.1	93/02/04 SMI"
...
#endif
#include	"sys/types.h"
/*#include "sys/seg.h" use this temporary version, selector #2 */
#include	"seg.h"
#if 0
