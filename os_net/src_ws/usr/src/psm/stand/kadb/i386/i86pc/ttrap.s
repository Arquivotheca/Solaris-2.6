...
/	actual or intended publication of such source code.
	...
	.ident	"@(#)ttrap.s	1.5	96/02/27 SMI"
...
/MP 8/12/92 Find out which cpu we are on
...
/ If we are currently locked and our cpu did it then do not try to lock forever
/ This is not a good way to do this since the mutex could get unlocked
/ this will have to be fixed soon BH
	cmpl	cur_cpuid,%eax
	je	we_have_mutex
...
no_multi:
	...
	movw    BFSsav, %fs
	movw    BGSsav, %gs
/MP 8/12/92 end of new multi code
...
/MP 8/12/92 Start of new multi cpu code
...
/routine to make an x_call to get other cpus into debugger
