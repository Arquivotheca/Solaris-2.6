#ident	"@(#)Makefile.com	1.110	96/07/25 SMI"
#
...
$(LIBSA) $(LIBNAMES) $(KADBPROMLIB) $(PLATLIB) $(LIBNFS_INET): FRC
	@cd $(@D); pwd; $(MAKE) $(@F)

$(L_LIBSA) $(L_LIBNAMES) $(L_PROMLIB) $(L_PLATLIB) $(L_LIBNFS_INET): FRC
	@cd $(@D); pwd; $(MAKE) $(@F)
