#
#ident	"@(#)Makefile.com	1.23	96/10/15 SMI"
#
...
#
$(UFSBOOT): $(UFS_MAPFILE) $(UFS_SRT0) $(UFS_OBJS) $(LIBDEPS)
...
$(HSFSBOOT): $(HSFS_MAPFILE) $(HSFS_SRT0) $(HSFS_OBJS) $(LIBDEPS)
...
$(NFSBOOT): $(ELFCONV) $(NFS_MAPFILE) $(NFS_SRT0) $(NFS_OBJS) $(LIBDEPS)
