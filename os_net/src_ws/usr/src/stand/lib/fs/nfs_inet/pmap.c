#pragma ident	"@(#)pmap.c	1.24	96/03/11 SMI"
...
extern enum clnt_stat rpc_call(u_long, u_long, u_long, xdrproc_t, caddr_t,
    xdrproc_t, caddr_t, int, int, struct sainet *, u_int);
