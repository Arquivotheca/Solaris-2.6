...
#pragma ident	"@(#)bootdef.h	1.17	96/04/26 SMI"
...
#endif
#define	SECBOOT_RELOCADDR	0x100000  /* Relocation address for non-srt0 */
...
/*	top of real-mode reachable memory				*/
#define	TOP_RMMEM	0xA0000
