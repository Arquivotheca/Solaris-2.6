...
#pragma ident	"@(#)FNSP_filesImpl.hh	1.1	96/03/31 SMI"

#include "../nis/FNSP_nisAddress.hh"
...
private:
	...
	FN_searchset * search_attrset_hu(
...
public:
	...
	FN_nameset* list_names(unsigned &status, int children_only = 0);

	FN_namelist *list_names_hu(unsigned &status);

	FN_bindingset* list_bindings(unsigned &status);
