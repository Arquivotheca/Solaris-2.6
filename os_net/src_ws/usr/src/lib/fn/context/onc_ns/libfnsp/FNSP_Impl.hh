...
#pragma ident	"@(#)FNSP_Impl.hh	1.1	96/03/31 SMI"
...
public:
	...
	virtual FN_nameset* list_names(unsigned &stat, int chld_only = 0) = 0;

	virtual FN_bindingset* list_bindings(unsigned &status) = 0;
	...
	virtual FN_searchset * search_attrset(
