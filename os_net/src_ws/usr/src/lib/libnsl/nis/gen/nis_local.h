...
#pragma ident	"@(#)nis_local.h	1.16	96/10/21 SMI"
...
nis_error nis_bind_dir(char *, int, nis_bound_directory **, u_long);
CLIENT *nis_client_handle(nis_bound_directory *, int, u_long);
nis_server *__nis_init_callback_x();
...
nis_error nis_bind_server(nis_server *srv, int nsrv,
		nis_bound_directory **binding);
nis_error nis_call(nis_call_state *state, u_long func,
