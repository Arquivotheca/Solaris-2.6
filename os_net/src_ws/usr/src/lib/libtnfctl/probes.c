...
#pragma ident	"@(#)probes.c	1.32	96/08/20 SMI"
...
static tnfctl_errcode_t count_probes(char *, paddr_t, void *,
					tnfctl_elf_search_t *);
static tnfctl_errcode_t read_a_probe(char *, paddr_t, void *,
					tnfctl_elf_search_t *);
...
/*ARGSUSED*/
static tnfctl_errcode_t
count_probes(char *name, paddr_t addr, void *rel_entry,
...
/*ARGSUSED*/
static tnfctl_errcode_t
read_a_probe(char *name, paddr_t addr, void *rel_entry,
	tnfctl_elf_search_t * search_info_p)
{
	 ...
	 * working copy)
	 */
	attrs = (paddr_t) prbctl_p->wrkprbctl.attrs;
