...
#pragma ident	"@(#)prb_rtld.c	1.11	96/05/20 SMI"
...
static prb_status_t bpt(prb_proc_ctl_t *proc_p, paddr_t addr);
static prb_status_t unbpt(prb_proc_ctl_t *proc_p, paddr_t addr);
 ...
 */
static prb_status_t
bpt(prb_proc_ctl_t *proc_p, paddr_t addr)
{
	prb_status_t	prbstat;
	bptsave_t	instr;
 ...
 */
prb_status_t
unbpt(prb_proc_ctl_t *proc_p, paddr_t addr)
{
	prb_status_t	prbstat;
