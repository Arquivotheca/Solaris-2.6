...
#pragma ident	"@(#)sym.c	1.10	96/08/20 SMI"
...
static tnfctl_errcode_t sym_findname_in_obj(int objfd, paddr_t baseaddr,
	paddr_t symaddr, char **symname);

static tnfctl_errcode_t sym_match(char *name, paddr_t addr, void *sym_entry,
	tnfctl_elf_search_t *search_info_p);

static tnfctl_errcode_t sym_matchname(char *name, paddr_t addr, void *sym_entry,
	tnfctl_elf_search_t *search_info_p);
 ...
 */
tnfctl_errcode_t
_tnfctl_sym_find_in_obj(int objfd, paddr_t baseaddr, const char *symname,
		paddr_t *symaddr)
{
 ...
 */
tnfctl_errcode_t
_tnfctl_sym_find(tnfctl_handle_t *hndl, const char *symname, paddr_t *symaddr)
{
 ...
 */
tnfctl_errcode_t
_tnfctl_sym_findname(tnfctl_handle_t *hndl, paddr_t symaddr,
	char **symname)
{
	boolean_t	release_lock;
	tnfctl_errcode_t	prexstat = TNFCTL_ERR_NONE;
...
sym_findname_in_obj(int objfd, paddr_t baseaddr, paddr_t symaddr,
	char **symname)
{
	tnfctl_errcode_t	prexstat = TNFCTL_ERR_NONE;
	sym_args_t	symargs;
 ...
 */
static tnfctl_errcode_t
sym_match(char *name, paddr_t addr, void *sym_entry,
	tnfctl_elf_search_t *search_info_p)
{
 ...
 */
static tnfctl_errcode_t
sym_matchname(char *name, paddr_t addr, void *sym_entry,
	tnfctl_elf_search_t * search_info_p)
{
	sym_args_t	*symargs_p = (sym_args_t *) search_info_p->record_data;
	Elf32_Sym	*sym = (Elf32_Sym *) sym_entry;
