...
#pragma ident	"@(#)prb_proc.h	1.22	96/08/20 SMI"
 ...
 */
void		prb_dbgaddr(prb_proc_ctl_t *proc_p, paddr_t dbgaddr);
...
prb_status_t	prb_proc_exit(prb_proc_ctl_t *proc_p, long syscall,
					prb_syscall_op_t op);
prb_status_t	prb_proc_entry(prb_proc_ctl_t *proc_p, long syscall,
					prb_syscall_op_t op);
prb_status_t	prb_proc_read(prb_proc_ctl_t *proc_p, paddr_t addr,
	void *buf, size_t size);
prb_status_t	prb_proc_write(prb_proc_ctl_t *proc_p, paddr_t addr,
	void *buf, size_t size);
