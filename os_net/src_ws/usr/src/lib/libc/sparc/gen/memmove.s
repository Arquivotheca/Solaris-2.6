...
.ident	"@(#)memmove.s	1.4	95/09/27 SMI"
 ...
 */
	...
	cmp	%i2, 9		! delay slot, for small counts copy bytes

	subcc	%i1, %i0, %i4	! get difference of two addresses
	bneg,a	1f
	neg	%i4		! if < 0, make it positive
1:	cmp	%i2, %i4	! compare size and abs(difference of addresses)
