...
extern void	__infnanstring();	/* Utility to copy inf */
...
#define	_rshift_b65536(x, n, c) ((((unsigned long) (x)) << \
				(16-(n))) + ((c)<<16))
...
extern const char __four_digits_quick_table[];  /* Table to translate */
			/* short unsigned < 10000 to four ASCII digits. */
