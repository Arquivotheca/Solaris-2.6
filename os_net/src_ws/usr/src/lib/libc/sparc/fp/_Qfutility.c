...
#ident	"@(#)_Qfutility.c	1.3	92/07/14 SMI"
...
/* the following __fpu_add3wc should be inlined as
 *	.inline	__fpu_add3wc,3
 *	ld	[%o1],%o4		! sum = x
...
/* the following __fpu_sub3wc should be inlined as
 *	.inline	__fpu_sub3wc,3
 *	ld	[%o1],%o4		! sum = *x
 *	addcc	-1,%o3,%g0		! restore last carry in cc reg
...
/* the following __fpu_neg2wc should be inlined as
 *	.inline	__fpu_neg2wc,2
 *	ld	[%o1],%o3		! tmp = *x
