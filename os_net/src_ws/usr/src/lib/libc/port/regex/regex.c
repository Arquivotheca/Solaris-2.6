    ...
    const char *stringp, ...)
{
    ...
    while (substringn < NSUBSTRINGS) {
        ...
        if ((substringp != (char *)0) &&
            ...
            returned_substringp = return_argp[return_arg_number[substringn]];
            if (returned_substringp != (char *)0) {
                while ((unsigned int)substringp <
                       (unsigned int)substring_endp[substringn]) {
    ...
    const char *count_stringp)
{
    ...
    *nmust_matchp = minimum_match_count;
    ...
    if (maximum_match_count == (int)UNLIMITED) {
        ...
        *nextra_matches_allowedp = maximum_match_count - minimum_match_count;
    }
    return;
    ...
    char_test_condition_t test_condition)
{
    ...
    while (nbytes_to_check > 0) {
        ...
        if (char_size <= 0) {
            ...
            if (char_size <= 0) {
                return (CHAR_TEST_ERROR);
            } else if (in_wchar_range(test_char, previous_char, current_char)) {
                if (test_condition == IN_CLASS) {
                    return (CONDITION_TRUE);
                } else {
                    return (CONDITION_FALSE);
    ...
    const char *regexp)
{
    ...
    while ((end_of_matchp == (char *)0) &&
           ((unsigned int)stringp > (unsigned int)repeat_startp)) {
        stringp--;
        end_of_matchp = test_string(stringp, regexp);
    }
    ...
    const char *regexp)
{
    ...
    for (;;) {
        ...
        switch ((int)*regexp) {
             ...
             *       expression uses to encode the case.  Each single character
             *       encoded in the compiled regular expression is
        ...
        case ASCII_CHAR|ZERO_OR_MORE:  /* char* */
            ...
            regexp++;
            return (test_repeated_ascii_char(repeat_startp, stringp, regexp));
        ...
        case ASCII_CHAR|COUNT:         /* char{min_count,max_count} */
            ...
            regexp++;
            get_match_counts(&nmust_match, &nextra_matches_allowed, regexp + 1);
            ...
            if (nmust_match > 0) {
                ...
                repeat_startp = stringp;
                while ((*stringp == *regexp) && (nextra_matches_allowed > 0)) {
        ...
        case MULTIBYTE_CHAR|ZERO_OR_MORE:   /* char* */
            ...
            repeat_startp = stringp;
            string_char_size = get_wchar(&string_wchar, stringp);
            while ((string_char_size > 0) && (string_wchar == regex_wchar)) {
                stringp += string_char_size;
                string_char_size = get_wchar(&string_wchar, stringp);
            }
            regexp += regex_char_size;
        ...
        case ANY_CHAR|COUNT:    /* .{min_count,max_count} */
            ...
            if (!multibyte) {
                ...
                if (nmust_match > 0) {
                    ...
                    repeat_startp = stringp;
                    while ((*stringp != '\0') && (nextra_matches_allowed > 0)) {
                        nextra_matches_allowed--;
                        stringp++;
                    }
                    regexp += 3;
        ...
        case NOT_IN_ASCII_CHAR_CLASS | COUNT:
             ...
             *            <class ...><minimum_match_count><maximum_match_count>
        ...
        case NOT_IN_MULTIBYTE_CHAR_CLASS|ZERO_OR_MORE:
            ...
            if ((int)*regexp == (int)(IN_MULTIBYTE_CHAR_CLASS|ZERO_OR_MORE)) {
                test_condition = IN_CLASS;
            } else {
                test_condition = NOT_IN_CLASS;
            }
        ...
        case NOT_IN_MULTIBYTE_CHAR_CLASS|ONE_OR_MORE:
            ...
            if ((int)*regexp == (int)(IN_MULTIBYTE_CHAR_CLASS|ONE_OR_MORE)) {
                test_condition = IN_CLASS;
            } else {
                test_condition = NOT_IN_CLASS;
            }
        ...
        case NOT_IN_OLD_ASCII_CHAR_CLASS|ZERO_OR_MORE:
            ...
            if ((int)*regexp == (int)(IN_OLD_ASCII_CHAR_CLASS|ZERO_OR_MORE)) {
                test_condition = IN_CLASS;
            } else {
                test_condition = NOT_IN_CLASS;
            }
        ...
        case NOT_IN_OLD_ASCII_CHAR_CLASS|ONE_OR_MORE:
            ...
            if ((int)*regexp == (int)(IN_OLD_ASCII_CHAR_CLASS|ONE_OR_MORE)) {
                test_condition = IN_CLASS;
            } else {
                test_condition = NOT_IN_CLASS;
            }
        ...
        case NOT_IN_OLD_ASCII_CHAR_CLASS|COUNT:
             ...
             *            <class ...><minimum_match_count><maximum_match_count>
             *         or <NOT_IN_OLD_ASCII_CHAR_CLASS|COUNT><class_length>\
             *            <class ...><minimum_match_count><maximum_match_count>
             *
             * NOTE: <class_length> includes the <class_length> byte
             *       but not the <minimum_match_count> or
        ...
        case ZERO_OR_MORE_GROUP|ADD_768_TO_GROUP_LENGTH:
            ...
            /*
             * encoded as <ZERO_OR_MORE_GROUP|ADDED_LENGTH_BITS><group_length>\
        ...
        case ONE_OR_MORE_GROUP|ADD_768_TO_GROUP_LENGTH:
            ...
            /*
             * encoded as <ONE_OR_MORE_GROUP|ADDED_LENGTH_BITS><group_length>\
             *            <compiled_regex...><END_GROUP|ONE_OR_MORE><groupn>
             *
             * NOTE:
             *
             * group_length + (256 * ADDED_LENGTH_BITS) ==
             *     length_of(<compiled_regex...><END_GROUP|ONE_OR_MORE><groupn>)
             */
        ...
        case END_GROUP|ONE_OR_MORE:                  /* (.....)+ */
            ...
            break; /* end case END_GROUP|ONE_OR_MORE */
