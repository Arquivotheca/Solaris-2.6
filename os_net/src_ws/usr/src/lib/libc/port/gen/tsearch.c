...
#ident	"@(#)tsearch.c	1.9	93/10/30 SMI"	/* SVr4.0 2.11	*/
...
static VOID *
_tsearch_unlocked(ky, rtp, compar) /* Find or insert key into search tree */
#ifdef __STDC__
...
static VOID *
_tdelete_unlocked(ky, rtp, compar)	/* Delete node with key key */
#ifdef __STDC__
const VOID *ky;		/* Key to be deleted */
#else
VOID *ky;		/* Key to be deleted */
#endif
