...
#ident	"@(#)__tbl_ntens.c	1.5	94/09/08 SMI"
...
const double __tbl_ntens[__TBL_TENS_MAX + 1] = {
	...
	1.0e-28, 1.0e-29,
	1.0e-30, 1.0e-31, 1.0e-32, 1.0e-33, 1.0e-34, 1.0e-35, 1.0e-36, 1.0e-37,
	1.0e-38, 1.0e-39,
	1.0e-40, 1.0e-41, 1.0e-42, 1.0e-43, 1.0e-44, 1.0e-45, 1.0e-46, 1.0e-47,
	1.0e-48, 1.0e-49};
