...
#pragma ident	"@(#)tnf_trace.h	1.22	95/07/19 SMI"
...
struct _tnf_ops {
	...
	void * (*alloc)(TNFW_B_WCB *, int, enum tnf_alloc_mode);
...
tnf_uint32_t 	tnf_probe_tag(tnf_ops_t *ops, tnf_probe_control_t *probe);
