...
#ident	"@(#)bootparams_getbyname.c	1.13	93/09/30	SMI"
...
bootparams_getbyname(name, linebuf, linelen)
...
/* ARGSUSED */
static int
str2bootent(instr, lenstr, ent, buffer, buflen)
	const char	*instr;
	int		lenstr;
