...
#ident	"@(#)vfscanf.c 1.2	96/06/21 SMI"
 ...
 * We call it vfscanf (like vfprintf)
 * even though it is really an internal routine.
 */
int
vfscanf(FILE *pfin, const char *fmt, va_list ap)
{
	int	nitems;
	int	ltoken;
	int	c;
