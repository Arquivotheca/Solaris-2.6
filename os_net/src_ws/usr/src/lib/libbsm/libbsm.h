...
#pragma ident	"@(#)libbsm.h	1.22	93/11/01 SMI"
...
extern int	adrf_u_char(adr_t *, u_char *, int);
extern int	adrf_u_int(adr_t *, u_int *, int);
extern int	adrf_u_long(adr_t *, u_long *, int);
extern int	adrf_u_short(adr_t *, u_short *, int);

#else /* not __STDC__ */

extern void	adr_char();
extern int	adr_count();
extern void	adr_long();
extern void	adr_short();
extern void	adr_start();
extern int	adrf_char();
extern int	adrf_int();
extern int	adrf_long();
extern int	adrf_short();
extern void	adrf_start();
extern int	adrf_string();
extern int	adrf_opaque();
extern int	adrf_u_char();
extern int	adrf_u_int();
extern int	adrf_u_long();
...
extern void	adrm_long(adr_t *, long *, int);
extern void	adrm_string(adr_t *, char *);
extern void	adrm_int(adr_t *, int *, int);
extern void	adrm_u_int(adr_t *, u_int *, int);
extern void	adrm_u_opaque(adr_t *, char *);
extern void	adrm_u_char(adr_t *, u_char *, int);
extern void	adrm_u_long(adr_t *, u_long *, int);
extern void	adrm_u_short(adr_t *, u_short *, int);
...
extern void	adrm_long();
extern void	adrm_string();
extern void	adrm_int();
extern void	adrm_u_int();
extern void	adrm_u_opaque();
extern void	adrm_u_char();
extern void	adrm_u_long();
