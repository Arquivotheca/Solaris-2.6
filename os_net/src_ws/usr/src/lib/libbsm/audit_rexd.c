#ifndef lint
static char	sccsid[] = "@(#)audit_rexd.c 1.4 93/01/26 SMI";
#endif
...
audit_rexd_setup()
{
	char	auditflags[256];	/* audit flags */
	au_mask_t	masks;			/* audit masks */
