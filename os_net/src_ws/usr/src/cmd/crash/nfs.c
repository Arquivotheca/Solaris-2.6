...
static char *nfs_heading = "ADDR      R_CNT V_CNT FLAGS ERROR       SIZE    NEXTR     CRED\n";
...
int full, lock;
{
	...
	fprintf(fp, "%8lx %6d%6d  %4x %5d %10d %8x %8x\n",
