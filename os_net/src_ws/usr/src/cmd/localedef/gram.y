 ...
 */
%{
#pragma	ident	"@(#)gram.y 1.26	96/08/23  SMI"
%}
...
methods :
	...
	{
	    /*
	     * If using euc bc mode then assume euc fc
	     */
	    if (Native == FALSE && Euc_filecode == FALSE) {
		fprintf(stderr,"cswidth must be specifed in extensions file\n");
		exit(1);
	    }
	}
	;
...
method_assign : 
	...
	| KW_MBTOWC string '\n'
	{
		...
		set_method(CHARMAP_MBTOWC_AT_NATIVE,1);
	}
	| KW_MBTOWC string string '\n'
	{
		...
		set_method(CHARMAP_MBTOWC_AT_NATIVE,2);
	}
	| KW_MBTOWC string string string '\n'
	{
		...
		set_method(CHARMAP_MBTOWC_AT_NATIVE,3);
	}
	| KW_MBSTOWCS string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(CHARMAP_MBSTOWCS_AT_NATIVE,1);
	}
	| KW_MBSTOWCS string string '\n'
	{
		...
		set_method(CHARMAP_MBSTOWCS_AT_NATIVE,2);
	}
	| KW_MBSTOWCS string string string '\n'
	{
		...
		set_method(CHARMAP_MBSTOWCS_AT_NATIVE,3);
	}
	| KW_WCTOMB string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(CHARMAP_WCTOMB_AT_NATIVE,1);
	}
	| KW_WCTOMB string string '\n'
	{
		...
		set_method(CHARMAP_WCTOMB_AT_NATIVE,2);
	}
	| KW_WCTOMB string string string '\n'
	{
		...
		set_method(CHARMAP_WCTOMB_AT_NATIVE,3);
	}
	| KW_WCSTOMBS string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(CHARMAP_WCSTOMBS_AT_NATIVE,1);
	}
	| KW_WCSTOMBS string string '\n'
	{
		...
		set_method(CHARMAP_WCSTOMBS_AT_NATIVE,2);
	}
	| KW_WCSTOMBS string string string '\n'
	{
		...
		set_method(CHARMAP_WCSTOMBS_AT_NATIVE,3);
	}
	| KW_WCWIDTH string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(CHARMAP_WCWIDTH_AT_NATIVE,1);
	}
	| KW_WCWIDTH string string '\n'
	{
		...
		set_method(CHARMAP_WCWIDTH_AT_NATIVE,2);
	}
	| KW_WCWIDTH string string string '\n'
	{
		...
		set_method(CHARMAP_WCWIDTH_AT_NATIVE,3);
	}
	| KW_WCSWIDTH string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(CHARMAP_WCSWIDTH_AT_NATIVE,1);
	}
	| KW_WCSWIDTH string string '\n'
	{
		...
		set_method(CHARMAP_WCSWIDTH_AT_NATIVE,2);
	}
	| KW_WCSWIDTH string string string '\n'
	{
		...
		set_method(CHARMAP_WCSWIDTH_AT_NATIVE,3);
	}
	| KW_MBFTOWC string '\n'
	{
	    if (Native == FALSE)
		set_method(CHARMAP_MBFTOWC,1);
	    else
		set_method(CHARMAP_MBFTOWC_AT_NATIVE,1);
	}
	| KW_MBFTOWC string string '\n'
	{
	    if (Native == FALSE)
		set_method(CHARMAP_MBFTOWC,2);
	    else
		set_method(CHARMAP_MBFTOWC_AT_NATIVE,2);
	}
	| KW_MBFTOWC string string string '\n'
	{
	    if (Native == FALSE)
		set_method(CHARMAP_MBFTOWC,3);
	    else
		set_method(CHARMAP_MBFTOWC_AT_NATIVE,3);
	}
	| KW_FGETWC string '\n'
	{
	    if (Native == FALSE)
		set_method(CHARMAP_FGETWC,1);
	    else
		set_method(CHARMAP_FGETWC_AT_NATIVE,1);
	}
	| KW_FGETWC string string '\n'
	{
	    if (Native == FALSE)
		set_method(CHARMAP_FGETWC,2);
	    else
		set_method(CHARMAP_FGETWC_AT_NATIVE,2);
	}
	| KW_FGETWC string string string '\n'
	{
	    if (Native == FALSE)
		set_method(CHARMAP_FGETWC,3);
	    else
		set_method(CHARMAP_FGETWC_AT_NATIVE,3);
	}
	| KW_TOWUPPER string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(CTYPE_TOWUPPER_AT_NATIVE,1);
	}
	| KW_TOWUPPER string string '\n'
	{
		...
		set_method(CTYPE_TOWUPPER_AT_NATIVE,2);
	}
	| KW_TOWUPPER string string string '\n'
	{
		...
		set_method(CTYPE_TOWUPPER_AT_NATIVE,3);
	}
	| KW_TOWLOWER string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(CTYPE_TOWLOWER_AT_NATIVE,1);
	}
	| KW_TOWLOWER string string '\n'
	{
		...
		set_method(CTYPE_TOWLOWER_AT_NATIVE,2);
	}
	| KW_TOWLOWER string string string '\n'
	{
		...
		set_method(CTYPE_TOWLOWER_AT_NATIVE,3);
	}
	| KW_WCTYPE string '\n'
	{
	...
	| KW_ISWCTYPE string '\n'
	{
		...
		set_method(CTYPE_ISWCTYPE_AT_NATIVE,1);
	}
	| KW_ISWCTYPE string string '\n'
	{
		...
		set_method(CTYPE_ISWCTYPE_AT_NATIVE,2);
	}
	| KW_ISWCTYPE string string string '\n'
	{
		...
		set_method(CTYPE_ISWCTYPE_AT_NATIVE,3);
	}
	| KW_STRCOLL string '\n'
	{
	...
	| KW_WCSCOLL string '\n'
	{
		...
		set_method(COLLATE_WCSCOLL_AT_NATIVE,1);
	}
	| KW_WCSCOLL string string '\n'
	{
		...
		set_method(COLLATE_WCSCOLL_AT_NATIVE,2);
	}
	| KW_WCSCOLL string string string '\n'
	{
		...
		set_method(COLLATE_WCSCOLL_AT_NATIVE,3);
	}
	| KW_WCSXFRM string '\n'
	{
	    if (Native == FALSE)
		...
		set_method(COLLATE_WCSXFRM_AT_NATIVE,1);
	}
	| KW_WCSXFRM string string '\n'
	{
		...
		set_method(COLLATE_WCSXFRM_AT_NATIVE,2);
	}
	| KW_WCSXFRM string string string '\n'
	{
		...
		set_method(COLLATE_WCSXFRM_AT_NATIVE,3);
	}
	| KW_REGCOMP string '\n'
	{
	...
	| KW_GETDATE string '\n'
	{
	    set_method(TIME_GETDATE,1);
	}
	| KW_GETDATE string string '\n'
	{
	    set_method(TIME_GETDATE,2);
	}
	| KW_GETDATE string string string '\n'
	{
	    set_method(TIME_GETDATE,3);
	}
	| KW_WCSFTIME string '\n'
	{
	...
	| KW_EUCPCTOWC string '\n'
	{
	    set_method(CHARMAP_EUCPCTOWC,1);
	}
	| KW_EUCPCTOWC string string '\n'
	{
	    set_method(CHARMAP_EUCPCTOWC,2);
	}
	| KW_EUCPCTOWC string string string '\n'
	{
	    set_method(CHARMAP_EUCPCTOWC,3);
	}
	| KW_WCTOEUCPC string '\n'
	{
	    set_method(CHARMAP_WCTOEUCPC,1);
	}
	| KW_WCTOEUCPC string string '\n'
	{
	    set_method(CHARMAP_WCTOEUCPC,2);
	}
	| KW_WCTOEUCPC string string string '\n'
	{
	    set_method(CHARMAP_WCTOEUCPC,3);
	}
	| KW_TRWCTYPE string '\n'
	{
	    set_method(CTYPE_TRWCTYPE,1);
	}
	| KW_TRWCTYPE string string '\n'
	{
	    set_method(CTYPE_TRWCTYPE,2);
	}
	| KW_TRWCTYPE string string string '\n'
	{
	    set_method(CTYPE_TRWCTYPE,3);
	}
	| KW_TOWCTRANS string '\n'
	{
	    if (Native == FALSE)
		set_method(CTYPE_TOWCTRANS,1);
	    else
		set_method(CTYPE_TOWCTRANS_AT_NATIVE,1);
	}
	| KW_TOWCTRANS string string '\n'
	{
	    if (Native == FALSE)
		set_method(CTYPE_TOWCTRANS,2);
	    else
		set_method(CTYPE_TOWCTRANS_AT_NATIVE,2);
	}
	| KW_TOWCTRANS string string string '\n'
	{
	    if (Native == FALSE)
		set_method(CTYPE_TOWCTRANS,3);
	    else
		set_method(CTYPE_TOWCTRANS_AT_NATIVE,3);
	}
	| KW_WCTRANS string '\n'
	{
	    set_method(CTYPE_WCTRANS, 1);
	}
	| KW_WCTRANS string string '\n'
	{
	    set_method(CTYPE_WCTRANS, 2);
	}
	| KW_WCTRANS string string string '\n'
	{
	    set_method(CTYPE_WCTRANS, 3);
	}
	| KW_FGETWC_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_FGETWC_AT_NATIVE, 1);
	}
	| KW_FGETWC_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_FGETWC_AT_NATIVE, 2);
	}
	| KW_FGETWC_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_FGETWC_AT_NATIVE, 3);
	}
	| KW_ISWCTYPE_AT_NATIVE string '\n'
	{
	    set_method(CTYPE_ISWCTYPE_AT_NATIVE, 1);
	}
	| KW_ISWCTYPE_AT_NATIVE string string '\n'
	{
	    set_method(CTYPE_ISWCTYPE_AT_NATIVE, 2);
	}
	| KW_ISWCTYPE_AT_NATIVE string string string '\n'
	{
	    set_method(CTYPE_ISWCTYPE_AT_NATIVE, 3);
	}
	| KW_MBFTOWC_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_MBFTOWC_AT_NATIVE, 1);
	}
	| KW_MBFTOWC_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_MBFTOWC_AT_NATIVE, 2);
	}
	| KW_MBFTOWC_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_MBFTOWC_AT_NATIVE, 3);
	}
	| KW_MBSTOWCS_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_MBSTOWCS_AT_NATIVE, 1);
	}
	| KW_MBSTOWCS_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_MBSTOWCS_AT_NATIVE, 2);
	}
	| KW_MBSTOWCS_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_MBSTOWCS_AT_NATIVE, 3);
	}
	| KW_MBTOWC_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_MBTOWC_AT_NATIVE, 1);
	}
	| KW_MBTOWC_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_MBTOWC_AT_NATIVE, 2);
	}
	| KW_MBTOWC_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_MBTOWC_AT_NATIVE, 3);
	}
	| KW_TOWLOWER_AT_NATIVE string '\n'
	{
	    set_method(CTYPE_TOWLOWER_AT_NATIVE, 1);
	}
	| KW_TOWLOWER_AT_NATIVE string string '\n'
	{
	    set_method(CTYPE_TOWLOWER_AT_NATIVE, 2);
	}
	| KW_TOWLOWER_AT_NATIVE string string string '\n'
	{
	    set_method(CTYPE_TOWLOWER_AT_NATIVE, 3);
	}
	| KW_TOWUPPER_AT_NATIVE string '\n'
	{
	    set_method(CTYPE_TOWUPPER_AT_NATIVE, 1);
	}
	| KW_TOWUPPER_AT_NATIVE string string '\n'
	{
	    set_method(CTYPE_TOWUPPER_AT_NATIVE, 2);
	}
	| KW_TOWUPPER_AT_NATIVE string string string '\n'
	{
	    set_method(CTYPE_TOWUPPER_AT_NATIVE, 3);
	}
	| KW_WCSCOLL_AT_NATIVE string '\n'
	{
	    set_method(COLLATE_WCSCOLL_AT_NATIVE, 1);
	}
	| KW_WCSCOLL_AT_NATIVE string string '\n'
	{
	    set_method(COLLATE_WCSCOLL_AT_NATIVE, 2);
	}
	| KW_WCSCOLL_AT_NATIVE string string string '\n'
	{
	    set_method(COLLATE_WCSCOLL_AT_NATIVE, 3);
	}
	| KW_WCSTOMBS_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_WCSTOMBS_AT_NATIVE, 1);
	}
	| KW_WCSTOMBS_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_WCSTOMBS_AT_NATIVE, 2);
	}
	| KW_WCSTOMBS_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_WCSTOMBS_AT_NATIVE, 3);
	}
	| KW_WCSXFRM_AT_NATIVE string '\n'
	{
	    set_method(COLLATE_WCSXFRM_AT_NATIVE, 1);
	}
	| KW_WCSXFRM_AT_NATIVE string string '\n'
	{
	    set_method(COLLATE_WCSXFRM_AT_NATIVE, 2);
	}
	| KW_WCSXFRM_AT_NATIVE string string string '\n'
	{
	    set_method(COLLATE_WCSXFRM_AT_NATIVE, 3);
	}
	| KW_WCTOMB_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_WCTOMB_AT_NATIVE, 1);
	}
	| KW_WCTOMB_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_WCTOMB_AT_NATIVE, 2);
	}
	| KW_WCTOMB_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_WCTOMB_AT_NATIVE, 3);
	}
	| KW_WCWIDTH_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_WCWIDTH_AT_NATIVE,1);
	}
	| KW_WCWIDTH_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_WCWIDTH_AT_NATIVE,2);
	}
	| KW_WCWIDTH_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_WCWIDTH_AT_NATIVE,3);
	}
	| KW_WCSWIDTH_AT_NATIVE string '\n'
	{
	    set_method(CHARMAP_WCSWIDTH_AT_NATIVE,1);
	}
	| KW_WCSWIDTH_AT_NATIVE string string '\n'
	{
	    set_method(CHARMAP_WCSWIDTH_AT_NATIVE,2);
	}
	| KW_WCSWIDTH_AT_NATIVE string string string '\n'
	{
	    set_method(CHARMAP_WCSWIDTH_AT_NATIVE,3);
	}
	| KW_TOWCTRANS_AT_NATIVE string '\n'
	{
	    set_method(CTYPE_TOWCTRANS_AT_NATIVE,1);
	}
	| KW_TOWCTRANS_AT_NATIVE string string '\n'
	{
	    set_method(CTYPE_TOWCTRANS_AT_NATIVE,2);
	}
	| KW_TOWCTRANS_AT_NATIVE string string string '\n'
	{
	    set_method(CTYPE_TOWCTRANS_AT_NATIVE,3);
	}
	| KW_FNMATCH string '\n'
	{
	    set_method(COLLATE_FNMATCH,1);
	}
	| KW_FNMATCH string string '\n'
	{
	    set_method(COLLATE_FNMATCH,2);
	}
	| KW_FNMATCH string string string '\n'
	{
	    set_method(COLLATE_FNMATCH,3);
	}
        ;
...
num_pair : number ':' number
	{
		...
		if (euc_info.euc_scrlen1 > charmap.cm_max_disp_width)
		...
		if (euc_info.euc_scrlen2 > charmap.cm_max_disp_width)
		...
		if (euc_info.euc_scrlen3 > charmap.cm_max_disp_width)
