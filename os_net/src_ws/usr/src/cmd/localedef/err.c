 ...
 * All rights reserved.
 */
#pragma	ident	"@(#)err.c 1.9	96/07/23  SMI"
...
static char rcsid[] = "@(#)$RCSfile: err.c,v $ $Revision: 1.4.6.3 $ (OSF) $Date: 1992/12/11 14:36:53 $";
#endif
/*
...
"Could not open temporary file '%' for write.\n",
...
"The symbol, %s, referenced has not yet been specified in the\n\
 collation order.\n",
"usage: localedef [-csdvw] [-x extfile] [-f charmap] [-i locsrc] \n\
