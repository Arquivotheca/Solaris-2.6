 ...
 * All rights reserved.
 */
#pragma	ident	"@(#)init.c 1.21	96/08/15  SMI"
...
static char rcsid[] = "@(#)$RCSfile: init.c,v $ $Revision: 1.4.5.3 $ (OSF) $Date: 1992/09/10 19:00:50 $";
#endif
/*
...
static void add_predef_classname(char *name, int mask)
{
