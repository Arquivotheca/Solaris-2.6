...
#ident	"@(#)rpc_svcout.c	1.21	94/12/17 SMI"

#ifndef lint
static char sccsid[] = "@(#)rpc_svcout.c	1.21	94/12/17 SMI";
#endif
...
serviced */\n");
			...
			f_print(fout, "\t\t/* Number of requests being \
serviced */\n");

			if (mtflag) {
				f_print(fout, "mutex_t _svcstate_lock;");
				f_print(fout, "\t\t\t/* lock for _rpcsvcstate, _rpcsvccount */\n");
