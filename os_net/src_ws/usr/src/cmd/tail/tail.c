...
#pragma	ident	"@(#)tail.c	1.29	96/07/01	SMI"	/* SVr4.0 1.14   */
...
keep:
	...
	if (!piped) {
		/*
		 * Calculate offset from end of file
		 */
		(void) fstat(0, &statb);
		di = !bylines && num < statb.st_size ? num : statb.st_size;
