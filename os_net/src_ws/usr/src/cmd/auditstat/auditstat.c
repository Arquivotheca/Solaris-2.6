#ifndef lint
static char	sccsid[] = "@(#)auditstat.c 1.2 93/02/18 SMI;";
...
char	**argv;
{
	...
	if (flags & NFLG)
		(void) printf("number of kernel events = %ld\n", s.as_numevent);
...
au_stat_t *s;
{
	...
	(void) sprintf(buf,
		"%4lu %n%4lu %n%4lu %n%4lu %n%4lu %n%4lu \
		%n%4lu %n%4lu %n%4lu %n%4lu %n%4lu %n%4lu%n",
