...
#ident	"@(#)ttyio.c	1.3	95/03/01 SMI"
...
#define	TTY_UNVAIL	"Unable to prompt user: /dev/tty is unavailable."
#define	TTY_ABORT	"Aborted"
#define	TTY_CONT	"Continuing"
#define	TTY_PROMPT	"%s: Ready for volume %u\n%s: Type \"go\" when ready to proceed (or \"quit\" to abort): \07"
#define	TTY_GO		"go"
#define	TTY_QUIT	"quit"
...
next(int mode)
{
    ...
    sprintf(msg, MSGSTR(TTY_PROMPT, TTY_PROMPT), myname, arvolume + 1,
        myname); 
    go = MSGSTR(TTY_GO, "go");
