...
#define	TAR_MODE  "%s: Exactly one of the c, t, r, u or x options must be specified.\n"
#define	TAR_BSIZE	"Tar: blocksize = %d\n"
#define	TAR_OPT		"%s: unknown option %c\n"
#define	TAR_ARG		"%s: %c argument missing\n"
#define	TAR_USAGE1	"Usage: %s -c[bfvw] device block filename..\n"
#define	TAR_USAGE2	"       %s -r[bvw] device block [filename...]\n"
#define	TAR_USAGE3	"       %s -t[vf] device\n"
#define	TAR_USAGE4	"       %s -u[bvw] device block [filename...]\n"
#define	TAR_USAGE5	"       %s -x[flmovw] device [filename...]\n"
