...
#pragma ident "@(#)stats_log.c   1.22     96/04/18 SMI"
...
stats_log_logfile_read(stats_cookie_t *st, int *type)
{
	...
	case CACHEFS_LOG_GETPAGE:
		if ((! xdr_int(xdrs, &getpage.error)) ||
		    ...
		    sizeof (getpage.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &getpage.fileno)) ||
		    (! xdr_long(xdrs, &getpage.uid)) ||
		    (! xdr_u_longlong_t(xdrs, &getpage.offset)) ||
	...
	case CACHEFS_LOG_READDIR:
		if ((! xdr_int(xdrs, &readdir.error)) ||
		    ...
		    sizeof (readdir.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &readdir.fileno)) ||
		    (! xdr_long(xdrs, &readdir.uid)) ||
		    (! xdr_u_longlong_t(xdrs, &readdir.offset)) ||
	...
	case CACHEFS_LOG_READLINK:
		if ((! xdr_int(xdrs, &readlink.error)) ||
		    ...
		    sizeof (readlink.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &readlink.fileno)) ||
	...
	case CACHEFS_LOG_REMOVE:
		if ((! xdr_int(xdrs, &remove.error)) ||
		    ...
		    sizeof (remove.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &remove.fileno)) ||
	...
	case CACHEFS_LOG_RMDIR:
		if ((! xdr_int(xdrs, &rmdir.error)) ||
		    ...
		    sizeof (rmdir.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &rmdir.fileno)) ||
	...
	case CACHEFS_LOG_TRUNCATE:
		if ((! xdr_int(xdrs, &truncate.error)) ||
		    ...
		    sizeof (truncate.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &truncate.fileno)) ||
		    (! xdr_long(xdrs, &truncate.uid)) ||
		    (! xdr_u_longlong_t(xdrs, &truncate.size))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_PUTPAGE:
		if ((! xdr_int(xdrs, &putpage.error)) ||
		    ...
		    sizeof (putpage.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &putpage.fileno)) ||
		    (! xdr_long(xdrs, &putpage.uid)) ||
		    (! xdr_u_longlong_t(xdrs, &putpage.offset)) ||
	...
	case CACHEFS_LOG_CREATE:
		if ((! xdr_int(xdrs, &create.error)) ||
		    ...
		    sizeof (create.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &create.fileno)) ||
	...
	case CACHEFS_LOG_MKDIR:
		if ((! xdr_int(xdrs, &mkdir.error)) ||
		    ...
		    sizeof (mkdir.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &mkdir.fileno)) ||
	...
	case CACHEFS_LOG_SYMLINK:
		if ((! xdr_int(xdrs, &symlink.error)) ||
		    ...
		    sizeof (symlink.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &symlink.fileno)) ||
	...
	case CACHEFS_LOG_POPULATE:
		if ((! xdr_int(xdrs, &populate.error)) ||
		    ...
		    sizeof (populate.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &populate.fileno)) ||
		    (! xdr_u_longlong_t(xdrs, &populate.off)) ||
	...
	case CACHEFS_LOG_CSYMLINK:
		if ((! xdr_int(xdrs, &csymlink.error)) ||
		    ...
		    sizeof (csymlink.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &csymlink.fileno)) ||
	...
	case CACHEFS_LOG_FILLDIR:
		if ((! xdr_int(xdrs, &filldir.error)) ||
		    ...
		    sizeof (filldir.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &filldir.fileno)) ||
	...
	case CACHEFS_LOG_MDCREATE:
		if ((! xdr_int(xdrs, &mdcreate.error)) ||
		    ...
		    sizeof (mdcreate.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &mdcreate.fileno)) ||
	...
	case CACHEFS_LOG_GPFRONT:
		if ((! xdr_int(xdrs, &gpfront.error)) ||
		    ...
		    sizeof (gpfront.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &gpfront.fileno)) ||
		    (! xdr_long(xdrs, &gpfront.uid)) ||
		    (! xdr_u_longlong_t(xdrs, &gpfront.off)) ||
	...
	case CACHEFS_LOG_RFDIR:
		if ((! xdr_int(xdrs, &rfdir.error)) ||
		    ...
		    sizeof (rfdir.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &rfdir.fileno)) ||
	...
	case CACHEFS_LOG_UALLOC:
		if ((! xdr_int(xdrs, &ualloc.error)) ||
		    ...
		    sizeof (ualloc.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &ualloc.fileno)) ||
		    (! xdr_u_longlong_t(xdrs, &ualloc.off)) ||
	...
	case CACHEFS_LOG_CALLOC:
		if ((! xdr_int(xdrs, &challoc.error)) ||
		    ...
		    sizeof (challoc.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &challoc.fileno)) ||
		    (! xdr_u_longlong_t(xdrs, &challoc.off)) ||
	...
	case CACHEFS_LOG_NOCACHE:
		if ((! xdr_int(xdrs, &nocache.error)) ||
		    ...
		    sizeof (nocache.fid))) ||
		    (! xdr_u_longlong_t(xdrs, &nocache.fileno))) {
			stats_perror(st, SE_CORRUPT,
...
stats_log_get_record_info(stats_cookie_t * sc,
    void *recp, caddr_t *vfsp, fid_t **fidp, ino64_t *filenop,
