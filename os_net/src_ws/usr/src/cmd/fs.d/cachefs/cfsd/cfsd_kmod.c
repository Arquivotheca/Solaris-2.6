 ...
 *
 */
#ident   "@(#)cfsd_kmod.c 1.5     96/03/09 SMI"
 ...
 */
int
kmod_rootfid(cfsd_kmod_object_t *kmod_object_p, fid_t *fidp)
{
	int error = 0;
	int xx;
 ...
 */
int
kmod_cidtofid(cfsd_kmod_object_t *kmod_object_p, cfs_cid_t *cidp, fid_t *fidp)
{
	int error = 0;
	int xx;
 ...
 */
int
kmod_getattrfid(cfsd_kmod_object_t *kmod_object_p, fid_t *fidp,
 ...
 */
int
kmod_getattrname(cfsd_kmod_object_t *kmod_object_p, fid_t *dirp,
 ...
 */
void
kmod_format_fid(cfsd_kmod_object_t *kmod_object_p, const fid_t *fidp)
{
	ulong_t val;
	int index;
	char format[10];
	...
	for (index = 0; index < (int)fidp->fid_len; index += sizeof (ulong_t)) {
