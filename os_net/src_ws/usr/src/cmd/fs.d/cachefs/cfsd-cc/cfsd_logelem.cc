...
#pragma ident   "@(#)cfsd_logelem.cc 1.12     96/02/28 SMI"
...
void
cfsd_logelem::i_print_attr(vattr_t *vp)
{
...
void
cfsd_logelem::i_format_fid(fid_t *fidp)
{
	ulong_t val;
	int index;
	char format[10];
...
cfsd_logelem_remove::logelem_roll(u_long *)
{
	...
	timestruc_t *ctimep = (va.va_nlink > 1) ? &i_up->dl_ctime : NULL;
