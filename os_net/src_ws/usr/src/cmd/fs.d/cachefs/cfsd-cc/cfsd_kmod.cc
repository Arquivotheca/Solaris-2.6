...
#pragma ident   "@(#)cfsd_kmod.cc 1.12     96/02/28 SMI"
...
int
cfsd_kmod::kmod_rootfid(fid_t *fidp)
{
...
int
cfsd_kmod::kmod_cidtofid(cfs_cid *cidp, fid_t *fidp)
{
...
int
cfsd_kmod::kmod_getattrfid(fid_t *fidp, cred_t *credp, vattr_t *vattrp)
{
...
int
cfsd_kmod::kmod_getattrname(fid_t *dirp, const char *name, cred_t *credp,
...
int
cfsd_kmod::kmod_create(fid_t *dirp, const char *namep, const cfs_cid_t *cidp,
...
int
cfsd_kmod::kmod_pushback(cfs_cid *filep, fid_t *fidp, cred_t *credp,
...
int
cfsd_kmod::kmod_rename(fid_t *olddir, const char *oldname, fid_t *newdir,
    const char *newname, const cfs_cid_t *cidp, cred_t *credp,
    timestruc_t *ctimep, timestruc_t *delctimep, const cfs_cid_t *delcidp)
{
...
int
cfsd_kmod::kmod_setattr(fid_t *fidp, const cfs_cid_t *cidp,
    vattr_t *vattrp, int flags,
...
int cfsd_kmod::kmod_setsecattr(fid_t *fidp, const cfs_cid_t *cidp,
...
int
cfsd_kmod::kmod_remove(const fid_t *fidp, const cfs_cid_t *cidp,
...
int
cfsd_kmod::kmod_link(const fid_t *dirfidp, const char *namep,
    const fid_t *filefidp, const cfs_cid_t *cidp, const cred_t *credp,
    timestruc_t *ctimep)
{
...
int
cfsd_kmod::kmod_mkdir(const fid_t *dirfidp, const char *namep,
...
int
cfsd_kmod::kmod_rmdir(const fid_t *dirfidp, const char *namep,
    const cred_t *credp)
{
...
int
cfsd_kmod::kmod_symlink(const fid_t *dirfidp, const char *namep,
    const cfs_cid_t *cidp,
...
void
cfsd_kmod::i_format_fid(const fid_t *fidp)
{
	ulong_t val;
	int index;
	char format[10];
...
void
cfsd_kmod::i_print_attr(const vattr_t *vp)
{
