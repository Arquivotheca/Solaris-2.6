...
#pragma ident "@(#)mount.c   1.51     96/08/21 SMI"
    ...
    char **backfstypepp, char **reducepp, int *notifyp)
{
	...
	*reducep = '\0';
	...
	if (margsp->cfs_options.opt_flags & CFS_DISCONNECTABLE) {
		/*
		 * proto=udp works around a bug with EIO being
		 *   returned instead of ETIMEDOUT, bugid 1215326
		 ...
		 *	rename
		 */
		strcat(reducep, ",proto=udp,retry=0");
