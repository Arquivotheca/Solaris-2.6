...
#pragma ident	"@(#)ypsym.h	1.11	96/01/29 SMI"
...
extern DBM *ypset_current_map(char *map, char *domain, ulong_t *error);
extern void ypclr_current_map(void);
extern void ypmkfilename();
extern int yplist_maps();
extern bool yp_map_access(SVCXPRT *transp, ulong_t *error, DBM *fdb);
extern bool ypget_map_order(char *map, char *domain, ulong_t *order);
