...
#ident	"@(#)ypserv_map.c	1.9	96/01/11 SMI"
 ...
 */
bool
ypget_map_order(char *map, char *domain, ulong_t *order)
{
	datum key;
	datum val;
 ...
 */
DBM *
ypset_current_map(char *map, char *domain, ulong_t *error)
{
 ...
 */
bool
yp_map_access(SVCXPRT *transp, ulong_t *error, DBM *fdb)
{
	char *ypname = "ypserv";
	struct netbuf *nbuf;
