...
# All rights reserved.
#
#ident	"@(#)mk.rc2.d.sh	1.27	95/01/12 SMI"
#

STARTLST=" 01MOUNTFSYS 05RMTMPFILES \
20sysetup 70uucp 71rpc 73nfs.client 74autofs 74syslog 76nscd \
75cron 82mkdtab 88utmpd 92volmgt 93cacheos.finish 99audit"

STOPLST="60nfs.server"
