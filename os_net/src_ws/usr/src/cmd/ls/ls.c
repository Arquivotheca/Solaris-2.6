...
#ident	"@(#)ls.c	1.34	96/05/31 SMI"	/* SVr4.0 1.38.5.17	*/
...
/*
 *	Copyright (c) 1986,1987,1988,1996 by Sun Microsystems, Inc.
 *	All Rights Reserved.
 */
/*
...
struct lbuf *ap;
{
	...
	if (iflg)
		if (mflg && !lflg)
			...
			curcol += printf((p->lnum < 100000) ? "%5llu "
				: "%llu ", p->lnum);
	if (sflg)
