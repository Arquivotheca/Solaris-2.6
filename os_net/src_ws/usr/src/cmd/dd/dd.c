...
#ident	"@(#)dd.c	1.22	96/04/18 SMI"	/* SVr4.0 1.18	*/
/*
**	convert and copy
*/
...
static unsigned long long	nbad;	/* count of bad records since last good one */
...
static unsigned long long	count;	/* number of input records to copy (0 = all) */
