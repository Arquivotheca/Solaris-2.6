...
#ident "@(#)opcodetable.c	1.4	94/07/21 SMI"
...
/*  [B0]  */	INVALID,		{"cmpxchg",TERM,RMw,1},		{"lss",TERM,MR,0},	{"btr",TERM,RMw,1},
...
/*  [C4]  */	INVALID,	INVALID,	{"cmpxchg8b",TERM,M,0},	INVALID,
