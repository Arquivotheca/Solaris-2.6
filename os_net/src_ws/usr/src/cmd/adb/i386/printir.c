...
#ident "@(#)printir.c	1.10     96/06/18 SMI"
	...
	int modif;
{
	...
	while (count) {
		...
		db_printf(2, "printstack: regp=%X, nargs=%D, pos.k_nargs=%D",
						regp, nargs, pos.k_nargs);
