...
#pragma ident	"@(#)fncopy_utils.cc	1.4	96/04/15 SMI"
...
// respective users
static const char *FNSP_user_map = "/var/fn/fns_user_";
static const char *FNSP_user_map_suffix = ".ctx";
static const char *dbm_pag = ".pag";
static const char *dbm_dir = ".dir";
...
FNSP_files_change_user_ownership(char *username)
{
	...
	sprintf(mapfile, "%s%s%s%s", FNSP_user_map, username,
	    FNSP_user_map_suffix, dbm_pag);
