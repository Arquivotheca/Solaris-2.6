...
#pragma ident	"@(#)expound.c	1.30	96/10/19 SMI"	/* SVr4.0 1.10	*/
...
static	void	show_dents64(process_t *, long, int);
static	void	show_rlimit(process_t *, long);
static	void	show_rlimit64(process_t *, long);
static	void	show_adjtime(process_t *, long, long);
static	void	show_sockaddr(process_t *, char *, long, long, int);
static	void	show_msghdr(process_t *, long);
...
expound(process_t *Pr, int r0, int raw)
{
	...
	case SYS_lstat64:
		if (!err && sys_nargs >= 2)
			show_stat64(Pr, (long)sys_args[1]);
		break;
	case SYS_xstat:
	case SYS_fxstat:
	case SYS_lxstat:
...
static void
show_itimerval(process_t *Pr, long offset, const char *name)
{
...
static void
show_timeval(process_t *Pr, long offset, const char *name)
{
...
static void
show_timestruc(process_t *Pr, long offset, const char *name)
{
...
static void
show_uname(process_t *Pr, long offset)
{
	/*
...
static void
show_ustat(process_t *Pr, long offset)
{
	struct ustat ubuf;
...
static void
show_fusers(process_t *Pr, long offset, int nproc)
{
	f_user_t fubuf;
	int serial = (nproc > 4);
...
static void
show_ioctl(process_t *Pr, int code, long offset)
{
...
static void
show_termio(process_t *Pr, long offset)
{
...
static void
show_termios(process_t *Pr, long offset)
{
...
static void
show_termiox(process_t *Pr, long offset)
{
...
static void
show_sgttyb(process_t *Pr, long offset)
{
...
static void
show_ltchars(process_t *Pr, long offset)
{
...
static void
show_tchars(process_t *Pr, long offset)
{
...
static void
show_termcb(process_t *Pr, long offset)
{
...
static void
show_strint(process_t *Pr, int code, long offset)
{
	int val;
...
static void
show_strioctl(process_t *Pr, long offset)
{
...
static void
show_strpeek(process_t *Pr, long offset)
{
...
static void
show_strfdinsert(process_t *Pr, long offset)
{
...
static void
show_strrecvfd(process_t *Pr, long offset)
{
...
#ifdef I_LIST
static void
show_strlist(process_t *Pr, long offset)
{
...
static void
show_jwinsize(process_t *Pr, long offset)
{
...
static void
show_winsize(process_t *Pr, long offset)
{
...
static void
show_flock(process_t *Pr, long offset)
{
	struct flock flock;
...
static void
show_share(process_t *Pr, long offset)
{
	struct fshare fshare;

	if (Pread(Pr, offset, (char *)&fshare, sizeof (fshare)) ==
	    sizeof (fshare)) {
		register const char *str = NULL;
...
static void
show_gp_msg(process_t *Pr, int what)
{
	register long offset;
...
static void
show_strbuf(process_t *Pr, long offset, const char *name, int dump)
{
...
static void
print_strbuf(process_t *Pr, struct strbuf *sp, const char *name, int dump)
{
	(void) printf(
...
static void
show_hhex_int(process_t *Pr, long offset, const char *name)
{
	int value;
...
static void
show_pollfd(process_t *Pr, long offset)
{
...
static void
show_msgctl(process_t *Pr, long offset)
{
...
static void
show_msgbuf(process_t *Pr, long offset, int msgsz)
{
	struct msgbuf msgb;
...
static void
show_semctl(process_t *Pr, long offset)
{
...
static void
show_semop(process_t *Pr, long offset, int nsops)
{
...
static void
show_shmctl(process_t *Pr, long offset)
{
...
static void
show_groups(process_t *Pr, long offset, int count)
{
	int groups[100];
...
static void
show_sigset(process_t *Pr, long offset, const char *name)
{
	sigset_t sigset;
...
static void
show_sigaltstack(process_t *Pr, long offset, const char *name)
{
...
static void
show_sigaction(process_t *Pr, long offset, const char *name, int odisp)
{
...
static void
show_siginfo(process_t *Pr, long offset)
{
...
static void
show_bool(process_t *Pr, long offset, int count)
{
...
static void
show_iovec(process_t *Pr, long offset, int niov, int showbuf, long count)
{
	iovec_t iovec[16];
	register iovec_t *ip;
	register int nb;
...
static void
show_dents(process_t *Pr, long offset, int count)
{
...
static void
show_dents64(process_t *Pr, long offset, int count)
{
...
static void
show_rlimit(process_t *Pr, long offset)
{
...
static void
show_rlimit64(process_t *Pr, long offset)
{
...
static void
show_nuname(process_t *Pr, long offset)
{
	struct utsname ubuf;
...
static void
show_adjtime(process_t *Pr, long off1, long off2)
{
...
static void
show_sockaddr(Pr, str, addroffset, lenoffset, len)
...
int len;
{
	/* A buffer large enough for MAXPATHLEN size AF_UNIX address */
	long buf[(sizeof (short) + MAXPATHLEN) / sizeof (long)];
	struct sockaddr *sa = (struct sockaddr *)buf;
	struct sockaddr_in *sin = (struct sockaddr_in *)buf;
	struct sockaddr_un *soun = (struct sockaddr_un *)buf;

	if (lenoffset != 0) {
		if (Pread(Pr, lenoffset, (char *)&len, sizeof (len)) !=
		    sizeof (len))
			return;
	}

	if (Pread(Pr, addroffset, (char *)buf, len) != len)
		return;
...
static void
show_msghdr(Pr, offset)
register process_t *Pr;
long offset;
{
	struct msghdr msg;

	if (Pread(Pr, offset, (char *)&msg, sizeof (msg)) != sizeof (msg))
		return;
	if (msg.msg_name != NULL && msg.msg_namelen != 0)
		show_sockaddr(Pr, "msg_name",
				(long)msg.msg_name, 0, msg.msg_namelen);
