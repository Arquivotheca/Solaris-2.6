...
#ident	"@(#)rpcb_svc_com.c	1.16	94/08/11 SMI"
...
allowed\n");
	...
	/*
	 * Disallow calling certain NIS (YP) and MOUNT procedures
	 * for security reasons.
	 */
	if (a.rmt_prog == YPPROG) {
		if (a.rmt_proc == YPPROC_FIRST || a.rmt_proc == YPPROC_NEXT ||
