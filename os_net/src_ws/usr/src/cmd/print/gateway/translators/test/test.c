/*
 * Copyright (c) 1995, 1996 by Sun Microsystem, Inc.
 * All Rights Reserved
 */

#pragma ident	"@(#)test.c	1.5	96/04/22 SMI"
...
test_spooler_available(const char *printer)
{
	...
	/*CSTYLED*/
	log_printf("test_spooler_available(%s): test-spooler-available = %s (%d)\n",
