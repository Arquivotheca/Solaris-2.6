...
static char	*bsm_sccsid = "@(#)allocate.h 1.8 93/07/13 SMI; SunOS BSM";
#endif
...
/* Legal Option Combinations */
#ifdef	SunOS_CMW
#define	ALLOC_OPTS	(SILENT | USER | LABEL | FORCE | TYPE)
#define	DEALLOC_OPTS	(SILENT | LABEL | FORCE | FORCE_ALL)
