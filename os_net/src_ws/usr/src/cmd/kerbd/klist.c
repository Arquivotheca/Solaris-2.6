#ident	"@(#)klist.c	1.1	91/06/25 SMI"
/*
 * $Source: /afs/athena.mit.edu/astaff/project/kerberos/src/kuser/RCS/klist.c,v $
 * $Author: jtkohl $ 
 *
...
"$Header: /afs/athena.mit.edu/astaff/project/kerberos/src/kuser/RCS/klist.c,v 4.15 89/08/30 11:19:16 jtkohl Exp $";
#endif	lint
