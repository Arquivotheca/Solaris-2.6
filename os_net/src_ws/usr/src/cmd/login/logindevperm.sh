...
#
#ident	"@(#)logindevperm.sh	1.3	96/07/31 SMI"
#
#
...
case "$MACH" in
	...
	#
	cat <<-EOM
	/dev/console    0600    /dev/vt00               # VT alias for console
	/dev/console    0600    /dev/vt01               # virtual terminal
	/dev/console    0600    /dev/vt02               # virtual terminal
	/dev/console    0600    /dev/vt03               # virtual terminal
	/dev/console    0600    /dev/vt04               # virtual terminal
	/dev/console    0600    /dev/vt05               # virtual terminal
	/dev/console    0600    /dev/vt06               # virtual terminal
	/dev/console    0600    /dev/vt07               # virtual terminal
	/dev/console    0600    /dev/vt08               # virtual terminal
	/dev/console    0600    /dev/vt09               # virtual terminal
	/dev/console    0600    /dev/vt10               # virtual terminal
	/dev/console    0600    /dev/vt11               # virtual terminal
	/dev/console    0600    /dev/vt12               # virtual terminal
	EOM
	;;
    "sparc" )
	# 
