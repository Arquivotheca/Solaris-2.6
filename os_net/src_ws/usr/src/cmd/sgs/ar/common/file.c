...
#pragma ident	"@(#)file.c	1.13	96/05/08 SMI"
...
static int search_sym_tab(Elf *, Elf32_Shdr *, Elf_Scn *,
...
#ifdef BROWSER
static void
sbrowser_search_stab(Elf *elf,
	int stabid, int stabstrid, char *arnam)
{
	Elf_Scn		*stab_scn;
	Elf_Scn		*stabstr_scn;
	Elf32_Shdr	*stab_sh;
...
static int
search_sym_tab(Elf *elf, Elf32_Shdr *shdr, Elf_Scn *scn, long mem_offset,
