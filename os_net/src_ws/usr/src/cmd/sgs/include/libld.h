 ...
 *	All rights reserved.
 */
#pragma ident	"@(#)libld.h	1.58	96/10/23 SMI"
...
struct ofl_desc {
	...
	u_longlong_t	ofl_flags;	/* various state bits, args etc. */
...
#define	FLG_OF_DYNAMIC	0x0000000001	/* generate dynamic output module */
#define	FLG_OF_STATIC	0x0000000002	/* generate static output module */
#define	FLG_OF_EXEC	0x0000000004	/* generate an executable */
#define	FLG_OF_RELOBJ	0x0000000008	/* generate a relocatable object */
#define	FLG_OF_SHAROBJ	0x0000000010	/* generate a shared object */
#define	FLG_OF_BFLAG	0x0000000020	/* do no special plt building: -b */
#define	FLG_OF_IGNENV	0x0000000040	/* ignore LD_LIBRARY_PATH: -i */
#define	FLG_OF_STRIP	0x0000000080	/* strip output: -s */
#define	FLG_OF_NOWARN	0x0000000100	/* disable symbol warnings: -t */
#define	FLG_OF_NOUNDEF	0x0000000200	/* allow no undefined symbols: -zdefs */
#define	FLG_OF_PURETXT	0x0000000400	/* allow no text relocations: -ztext  */
#define	FLG_OF_GENMAP	0x0000000800	/* generate a memory map: -m */
#define	FLG_OF_DYNLIBS	0x0000001000	/* dynamic input allowed: -Bdynamic */
#define	FLG_OF_SYMBOLIC	0x0000002000	/* bind global symbols: -Bsymbolic */
#define	FLG_OF_ADDVERS	0x0000004000	/* add version stamp: -Qy */
#define	FLG_OF_MEMORY	0x0000008000	/* produce a memory model */
#define	FLG_OF_SEGORDER	0x0000010000	/* segment ordering is required */
#define	FLG_OF_SEGSORT	0x0000020000	/* segment sorting is required */
#define	FLG_OF_TEXTREL	0x0000040000	/* text relocations have been found */
#define	FLG_OF_MULDEFS	0x0000080000	/* multiple symbols are allowed */
#define	FLG_OF_OUTMMAP	0x0000100000	/* output image is mmaped to file */
#define	FLG_OF_BLDGOT	0x0000200000	/* build GOT table */
#define	FLG_OF_VERDEF	0x0000400000	/* record version definitions */
#define	FLG_OF_VERNEED	0x0000800000	/* record version dependencies */
#define	FLG_OF_NOVERSEC 0x0001000000	/* don't record version sections */
#define	FLG_OF_AUTOLCL	0x0002000000	/* automatically reduce unspecified */
					/*	global symbols to locals */
#define	FLG_OF_PROCRED	0x0004000000	/* process any symbol reductions by */
					/*	effecting the symbol table */
					/*	output and relocations */
#define	FLG_OF_BINDSYMB	0x0008000000	/* individual symbols are being bound */
					/*	symbolically (mapfile entry) */
#define	FLG_OF_AUX	0x0010000000	/* ofl_filter is an auxiliary filter */
#define	FLG_OF_WEAKEXT	0x0020000000	/* allow archive extraction to */
					/*	resolve weak references */
#define	FLG_OF_FATAL	0x0040000000	/* fatal error during input */
#define	FLG_OF_VOID	0x0080000000	/* bug ansi c compiler */
#define	FLG_OF_WARN	0x0100000000	/* warning durring input processing. */
#define	FLG_OF_RELDYN	0x0200000000	/* process .dynamic in rel obj */
...
#define	FLG_IF_DEPREQD	0x020		/* dependency is required to satisfy */
					/*	symbol references */
#define	FLG_IF_NEEDSTR	0x040		/* dependency specified by -Nneeded */
...
#define	FLG_SY_MAPREF	0x0200		/* symbol reference generated by user */
					/*	from mapfile */
#define	FLG_SY_REFRSD	0x0400		/* symbols sd_ref has been raised */
...
#define	FLG_SY_INVALID	0x8000		/* unwanted/erroneous symbol */
