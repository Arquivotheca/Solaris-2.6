...
#ident "@(#)pcmciad.c	1.41     96/06/18 SMI"
...
#define	SOCKET(socket)	((socket) & 0xFF)
#define	FUNCTION(socket) ((socket) >> 8)
...
static struct driver_aliases	*aliases;
