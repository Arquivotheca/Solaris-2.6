...
#ident	"@(#)streamio.c	1.6	96/10/03 SMI"	/* SVr4.0 1.2	*/
...
#endif
{
	...
	/*
	 * There is no need to try more since the EAGAIN mechanism is
	 * already in place and working. The sleep and timeout here only makes
	 * lpsched/lpNet wait here and slows down the responses.
	 */
	...
	/*
	 * We return here and now, no need to try other schemes.
	 * These are the leftovers of (very early) development code.
	 */
#if 0
#ifdef	DEBUG
	{
