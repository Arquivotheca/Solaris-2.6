...
#pragma ident	"@(#)him_scb.h	1.15	96/07/30 SMI"

#ifdef	__cplusplus
extern "C" {
#endif

/* $Header:   Y:\source\aic-7870\him\common\him_scb.hv_   1.72.1.4   05 Oct 1995 14:44:46   KLI  $ */
...
/*	Solaris extensions to scb					   */
   struct adp_cmd *Sp_cmdp;         /* ptr to GHD cmd */
   unsigned long   Sp_paddr;	    /* SCB physical address */
...
/****************************************************************************
               %%% Target Mode Sequencer Control Block (SCB) %%%
****************************************************************************/
#ifdef _TARGET_MODE

typedef struct TSCB                 /* Bit-wise definitions for TARGET HIM */
{
   union
   {
      struct TSCB *Next;            /* next Target_SCB pointer on queue    */
      DWORD _void;                  /* DWORD entry to align rest of struct */
   } Sp_queue;
   union
   {
   ...
   struct
   {
      DWORD Cmd:8;                  /* Target_SCB command type             */
      DWORD Stat:8;                 /* Target_SCB command status           */
      DWORD Discon_en:1;            /* Disconnect enabled by the initiator */
      DWORD Abort:1;                /* Abort msg is received               */
      DWORD DeviceRst:1;            /* Bus Device Reset Msg is received    */
      DWORD Immed:1;                /* Immediate return to initiator       */
      DWORD Check:1;                /* Check condition returned            */
      DWORD Rsvd1:3;                /* Reserved = 0                        */
      DWORD MgrStat:8;              /* Intermediate status of Target_SCB   */
   } Sp_Control;
   union
   {
      DWORD target_seq_array[8];    /* Double-word array for SCB download  */
      struct 
      {
         DWORD InitiatorLUN:8;      /* Initiator ID and Target LUN         */
         DWORD Rsvd1:3;             /* Reserved for future                 */
         DWORD DataDir:1;           /* Data Transfer Directions            */
                                    /* 1 = Data IN; 0 = Data OUT           */
         DWORD Rsvd2:3;             /* Reserved for future                 */
         DWORD TargetScb:1;         /* This is a Target Scb                */
         DWORD CDBLen:8;            /* Length of Command Descriptor Block  */
         DWORD SegCnt:8;            /* Number of Scatter/Gather segments   */
         DWORD SegPtr;              /* Pointer to Scatter/Gather List      */
         DWORD CDBPtr;              /* Pointer to Command Descriptor Block */
         DWORD Status:8;            /* Status byte to be returned          */
         DWORD MsgIn:8;             /* MessageIn byte sent after Status    */
         DWORD NextPtr:12;          /* Pointer to next SCB to be executed  */
         DWORD MsgByte:4;           /* Number of bytes in Sp_ExtMsg[] valid*/
         DWORD Rsvd4:4;             /* Reserved for future                 */
         DWORD Rsvd5[3];            /* Reserved for future                 */
         DWORD Rsvd6:16;            /* Reserved for future                 */
         DWORD Rsvd7:8;             /* Reserved for future                 */
         DWORD HaStat:8;            /* Host Adapter Status                 */
      } target_seq_struct;
   }Sp_seq_scb;
   DWORD Reserved1;                 /* Pointer to Sense Area               */
   DWORD Reserved2;                 /* Sense Length                        */
   UBYTE Sp_CDB[MAX_CDB_LEN];       /* SCSI Command Descriptor Block       */
   UBYTE Sp_ExtMsg[8];              /* Work area for extended messages     */
   UBYTE SenseKey;                  /* Sense Key information from the HIM  */
   UBYTE SenseCode;                 /* Sense Code information from the HIM */
   UBYTE Sp_Reserved[4];            /* Reserved for future expansion       */
}Target_SCB;

#define  TSP_TgtSCB     Sp_seq_scb.target_seq_struct.TargetScb
#define  TSP_InitLun    Sp_seq_scb.target_seq_struct.InitiatorLUN
#define  TSP_DataDir    Sp_seq_scb.target_seq_struct.DataDir
#define  TSP_CDBLen     Sp_seq_scb.target_seq_struct.CDBLen
#define  TSP_CDBPtr     Sp_seq_scb.target_seq_struct.CDBPtr
#define  TSP_SegPtr     Sp_seq_scb.target_seq_struct.SegPtr
#define  TSP_Status     Sp_seq_scb.target_seq_struct.Status
#define  TSP_MsgIn      Sp_seq_scb.target_seq_struct.MsgIn 
#define  TSP_SegCnt     Sp_seq_scb.target_seq_struct.SegCnt
#define  TSP_MsgByte    Sp_seq_scb.target_seq_struct.MsgByte
#define  ACTIVE         0x42
#define  SCB_SENDING    0x43
#endif      /* of TARGET_MODE */
/****************************************************************************
                        %%% Sp_Cmd values %%%
****************************************************************************/
...
#define  HIMSCB_COMP    0x08        /* HIM Target SCB completed            */
...
#define  LUN            0x0f        /* SCSI target's logical unit number   */
...
#define  HOST_DETECTED_ERR 0x48     /* Initiator detected error (parity)   */
#ifdef _TARGET_MODE
#define  CMD_ABT_INIT   0x50        /* Command Aborted by the Initiator    */
#define  BUS_DEV_RESET  0x51        /* Bus Device Reset received by init   */
#endif /* _TARGET_MODE  */
...
#define  AE_HA_ABTACTIVE 3          /* Host Adapter abort active SCB    */
...
{                                   /*    HOST ADAPTER IDENTIFICATION      */
   ...
   union
   {
      ...
      struct
      {
         ...
         DWORD TargetModeAvailable:1;   /* Target Mode HIM available           */
         DWORD ResvByte2:5;         /* Reserved for future use             */
         DWORD ResvByte3:4;         /* Reserved for future use             */
         DWORD AutoTermCurrent:1;   /* AutoTermination - current sensing   */
         DWORD AutoTermCable:1;     /* AutoTermination - cable detection   */
         DWORD ScamEnable:1;        /* Scam active                         */
   ...
   ddi_acc_handle_t ab_handle;      /* for 2.5 PCI DDI */
...
#define  CFP_AutoTermCable    Cf_flags.flags_struct.AutoTermCable
#define  CFP_AutoTermCurrent  Cf_flags.flags_struct.AutoTermCurrent

#ifdef _SCAM
#define  CFP_ScamEnable       Cf_flags.flags_struct.ScamEnable
#endif   /* of _SCAM */
...
/***************************************/
typedef union spdword
{
   DWORD dword;
   sp_struct *sp;
#ifdef _TARGET_MODE
   Target_SCB *TargetSCB_Ptr;
#endif
} sp_dword;
...
typedef struct hsp
{
   sp_dword Head_Of_Q;        /* First SCB ptr on Queue              */
   sp_dword End_Of_Q;         /* Last SCB ptr on Queue               */
   ...
   UBYTE Hsp_SaveScr[64];           /* SCRATCH RAM Save Area within        */
                                    /*  him_struct                         */
#ifdef _TARGET_MODE
   Target_SCB target_scb;           /* Target Mode SCB definition          */
#endif
...
#ifdef _TARGET_MODE
#define CFP_TargetMode  config_ptr->Cf_flags.flags_struct.TargetModeAvailable
#define CFP_TargetSCB   (config_ptr->Cf_hsp_ptr.HaDataPtr)->target_scb
#define Target_Seq      Sp_seq_scb.target_seq_struct
#endif
...
/****************************************************************************
                      %%% cable installation info values %%%
****************************************************************************/
#define  CABLE_INT50    0x01        /* internal 50-pin cable installed */
#define  CABLE_INT68    0x02        /* internal 68-pin cable installed */
#define  CABLE_EXT      0x04        /* external cable installed */
...
/****************************************************************************
               %%% Autotermination Information Structure %%%
****************************************************************************/
typedef struct {
   UBYTE AutoTermHigh:1;
   UBYTE AutoTermLow:1;
   UBYTE Rsvd:6;
} termination_struct;
...
UWORD Ph_UpdateEeprom (cfp_struct *, register AIC_7870 *, UWORD address);
UWORD Ph_ReadE2Register (UWORD,register AIC_7870 *,int, cfp_struct *);
void Ph_Wait2usec (UBYTE,register AIC_7870 *, cfp_struct *);
UWORD Ph_RebuildEEControl (cfp_struct *, UWORD);
UWORD Ph_WriteE2Register (UWORD,register AIC_7870 *,int, UWORD, cfp_struct *);
UWORD Ph_EnableEraseWriteEE (register AIC_7870 *, int, cfp_struct *);
UWORD Ph_DisableEraseWriteEE (register AIC_7870 *, int, cfp_struct *);
void Ph_SendStartBitEE (register AIC_7870 *, cfp_struct *);
void Ph_SendAddressEE (register AIC_7870 *, int, UWORD, cfp_struct *);
void Ph_Wait2usec (UBYTE,register AIC_7870 *, cfp_struct *);
...
void Ph_ResetSCSI (AIC_7870 *, cfp_struct *);
...
void Ph_SetNeedNego (UBYTE, register AIC_7870 *, cfp_struct *);
...
void Ph_ParityError (sp_struct *,register AIC_7870 *);
...
void Ph_Pause (register AIC_7870 *, cfp_struct *);
void Ph_UnPause (register AIC_7870 *, cfp_struct *);
void Ph_WriteHcntrl (register AIC_7870 *,UBYTE, cfp_struct *);
UBYTE Ph_ReadIntstat (register AIC_7870 *, cfp_struct *);
void Ph_Delay(AIC_7870 *, int, cfp_struct *);
void Ph_ScbRenego (cfp_struct *,UBYTE);
void Ph_ResetSCSIBus (register AIC_7870 *);

void Ph_ClearFast20Reg (cfp_struct *,sp_struct *);
void Ph_LogFast20Map (cfp_struct *,sp_struct *);

#ifdef _SCAM
void Ph_Wait4Release (UBYTE,UBYTE, register AIC_7870 *);
DWORD Ph_AssignID (cfp_struct *, UWORD);
UWORD Ph_ChooseSCAMID(cfp_struct *, UWORD, UBYTE, UBYTE);
void Ph_ScamInitiate (cfp_struct *);
void Ph_FindScamDevs(cfp_struct *);
void Ph_BusDeviceResets (cfp_struct *, register AIC_7870 *);
UWORD Ph_SelectTarget (cfp_struct *, UBYTE);
UWORD Ph_FindNonScamDevs (cfp_struct *);
UBYTE Ph_ScamTransferInfoIn (register AIC_7870 *, UBYTE);
void  Ph_ScamTransferInfoOut (register AIC_7870 *, UBYTE);
UWORD PH_ScamProtocol(cfp_struct *);
#endif   /* of _SCAM */

void Ph_AutoTermCable (cfp_struct *);
void Ph_NoAssistTerm (cfp_struct *);
UBYTE Ph_ReadCableStatus (cfp_struct *);
void Ph_UpdateTerm (cfp_struct *);
UWORD PH_CheckTermination (cfp_struct *);
...
#ifdef _TARGET_MODE      
void  PH_TargetScbSend(Target_SCB *);
void  Ph_TargetIntSelIn(cfp_struct *);
void  Ph_TargetHndlMsgO (Target_SCB *, AIC_7870 *);
void  Ph_Cleanup(Target_SCB *);
void  Ph_SetTargetSCB (cfp_struct *);
#endif   /* end of TARGET_MODE   */
...
void Ph_OutBuffer (register AIC_7870 *,UBYTE *,int, cfp_struct *);
void Ph_InBuffer (register AIC_7870 *,UBYTE *,int, cfp_struct *);
