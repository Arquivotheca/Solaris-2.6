/* $Header:   Y:/source/aic-7870/him/himd/drvr_mac.hv_   1.21.1.1   14 Aug 1995 11:58:10   YU1868  $ */
/***************************************************************************
*                                                                          *
 ...
 */
#pragma ident	"@(#)drvr_mac.h	1.7	96/03/13 SMI"
...
#define  PHM_UNITCHECKCONDITION(scb_ptr) ((scb_ptr)->SP_MgrStat == \
               SCB_AUTOSENSE)
...
#define  PHM_INCLUDEATHENA(device_id) !((device_id) & 0x08000000)
