...
#pragma	ident	"@(#)chs_viper.h	1.2	96/06/18 SMI"
...
#define	CHS_V_ESB_CMD_P_ABORTED	0xf4	/*
						 * Command aborted by
						 * PDM_KILL_BUCKET
						 */

#define	CHS_V_ESB_CMD_ABORTED	0xf5	/*
						 * Command aborted by scsi
						 * controller
						 */

#define	CHS_V_ESB_FAILED_ABORT	0xf6	/*
						 * Abort failed due to SCSI
						 * bus reset
						 */

#define	CHS_V_ESB_BUS_RESET	0xf7		/* SCSI bus reset by adapter */

#define	CHS_V_ESB_BUS_RESET_OTHER	0xf8	/*
						 * SCSI bus reset by other
						 * device
						 */

#define	CHS_V_ESB_ARQ_FAILED	0xf9	/* ARQ attempt failed */

#define	CHS_V_ESB_MSG_REJECTED	0xfa	/*
						 * Device rejected a SCSI
						 * message
						 */
...
#define	CHS_V_ESB_TGT_NORESPOND	0xfd	/*
						 * Target device not responding
						 */

#define	CHS_V_ESB_CHN_UNFUNC	0xfe	/*
						 * SCSI channel(s) not
						 * functioning
						 */
