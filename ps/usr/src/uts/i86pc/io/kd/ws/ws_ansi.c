...
#pragma	ident "@(#)ws_ansi.c	1.5	96/07/30 SMI"
...
extern void	tcl_bs(wstation_t *, channel_t *, termstate_t *);
extern void	tcl_ht(wstation_t *, channel_t *, termstate_t *);
extern void	tcl_scrlup(wstation_t *, channel_t *, termstate_t *);
extern void	tcl_reset(wstation_t *, channel_t *, termstate_t *);
extern void	tcl_bht(wstation_t *, channel_t *, termstate_t *);


/* function prototypes for functions defined in this file */
void	wsansi_parse(wstation_t *, channel_t *, unchar *, int);
void	wsansi_cntl(wstation_t *, channel_t *, termstate_t *, ushort);
 ...
 */
void
wsansi_parse(wstation_t *wsp, channel_t *chp, unchar *addr, int cnt)
{
 ...
 */
void
wsansi_cntl(wstation_t *wsp, channel_t *chp, termstate_t *tsp, ushort ch)
{
	switch (ch) {
	case A_BEL:
		(*wsp->w_bell)(wsp, chp);
