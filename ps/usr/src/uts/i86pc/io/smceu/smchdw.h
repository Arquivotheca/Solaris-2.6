...
#ident	"@(#)smchdw.h 1.2	95/07/18 SMI"

/*
 * Module: SMCHDW.H Hardware Header File for SMC Ethernet LAN Adapters
...
#ident "@(#)smchdw.h	1.00 - 93/06/10"

#define SMC_MAX_PACKET_SIZE	1514
#define SMC_HEADER_SIZE	14
#define SMC_MAX_LOOKAHEAD (256-4-SMC_HEADER_SIZE)
...
#define	EER_BIT5	0x020	/* (Not Used) */
...
#define	BPR_EIL		0x004	/* Interrupt Enable*/
#define	BPR_BMSTR	0x004	/* Bus Master Enable in 82M32*/
...
#define INTCR_SINT		0x08
#define INTCR_MSK2		0x04
#define INTCR_MSK1		0x02
#define INTCR_EIL		0x01
...
#define	IAR7_BIT0	0x001	/* Not used in ISA mode.*/
...
#define	GCR_CHCHK	0x080	/* Channel Check (Not used)*/
...
#define	PG_MSK		0x3F	/* Used to zero the page select bits in REG_CMD*/
...
#define	REG_ERWCNT	0x018	/* Register Offset*/
/*////////////////////////////////////////////////////////////////////////////
...
#define	IMR_ERWE	0x040	/* Early Receive Interrupt Enable*/
...
/*////////////////////////////////////////////////////////////////////////////
// Offset 1Fh (NIC offset 0Fh): MANCH - Status read-back of 10BaseT LED drivers
// Read  page 3
// Write page 3
*/

#define REG_MANCH	0x1F	
