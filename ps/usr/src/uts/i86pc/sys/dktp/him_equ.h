...
#pragma ident	"@(#)him_equ.h 1.4	94/07/09 SMI"

/* Defines for use with the esa (AIC-7770) driver */

/* $Header:   V:\source\code\aic-7770\him\common\him_equ.hv_   1.5   27 May 1994 12:39:54   FANNIN  $ */
/****************************************************************************
...
#define  MSGNULL        0xFF     /* Invalid message code for error handling */
...
#define  MACDONE           0xF0     /* Sequencer Macro complete (no interrupt) */
