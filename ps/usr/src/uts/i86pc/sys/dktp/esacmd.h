...
#ifndef _SYS_DKTP_ESACMD_H
#define _SYS_DKTP_ESACMD_H

#pragma ident	"@(#)esacmd.h	1.6	94/06/17 SMI"
...
/*
 * Macros to flip from scsi_pkt to esa_scsi_cmd (hba pkt private data)
 */
#define	PKT2CMD(pkt)	((struct esa_scsi_cmd *)(pkt)->pkt_ha_private)
...
struct 	esa_scsi_cmd {
	...
	struct esa_scsi_cmd *cmd_linkp;	/* link ptr for callbacks */
