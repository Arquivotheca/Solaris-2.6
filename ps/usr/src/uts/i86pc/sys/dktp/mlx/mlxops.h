...
#pragma ident	"@(#)mlxops.h	1.1	95/10/16 SMI"
...
typedef	struct mlxops {
	...
	unchar	(*mlx_cready)(mlx_t *mlxp);
	bool_t	(*mlx_csend)(mlx_t *mlxp, void *hw_ccbp);
	unchar	(*mlx_iready)(mlx_t *mlxp);
	unchar	(*mlx_get_istat)(mlx_t *mlxp, void *hw_statp, int clear);
	int	(*mlx_geometry)(mlx_t *mlxp, struct scsi_address *ap, ulong bl);
} nops_t;
