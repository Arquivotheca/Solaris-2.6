...
#pragma ident	"@(#)tcl.h	1.3	96/06/02 SMI"
...
#define	TCL_INTENSITY_BKGRD_COLOR	70
...
extern int tcl_curattr(channel_t *chp);
extern void tcl_norm(wstation_t *wsp, channel_t *chp, termstate_t *tsp,
    ushort ch);
extern void tcl_cursor(wstation_t *wsp, channel_t *chp);
extern void tcl_reset(wstation_t *wsp, channel_t *chp, termstate_t *tsp);
extern void tcl_bht(wstation_t *wsp, channel_t *chp, termstate_t *tsp);
extern void tcl_scrlup(wstation_t *wsp, channel_t *chp, termstate_t *tsp);
extern void tcl_ht(wstation_t *wsp, channel_t *chp, termstate_t *tsp);
extern void tcl_bs(wstation_t *wsp, channel_t *chp, termstate_t *tsp);
