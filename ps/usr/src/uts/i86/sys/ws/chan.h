...
#pragma ident	"@(#)chan.h	1.3	94/09/03 SMI"
...
/*
 * chp_stype CH_CHAR_MODE used by CHAR to tell KD when the stream
 * is in raw or cooked mode
 */
#define	CH_CHAR_MODE	(('C'<<24) | ('H'<<16) | ('C'<<8) | 'M')
