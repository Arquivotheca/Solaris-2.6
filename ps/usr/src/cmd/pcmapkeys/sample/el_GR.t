...
'I'	<IOTA-diaeresis>         # IOTA diaeresis
'Y'	<UPSILON-diaeresis>         # UPSILON diaeresis
'i'	<iota-diaeresis>         # iota diaeresis
'y'	<upsilon-diaeresis>         # upsilon diaeresis
#
dead: <diaeresis-tonos>			# diaeresis and tonos
' '   ' '
'i'	<iota-accent-diaeresis>         # iota diaeresis & accent
'y'	<upsilon-acc-diaeresis>         # upsilon diaresis & accent
#
#
