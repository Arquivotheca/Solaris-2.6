...
#ifndef _PFGREMQUERY_UI_H_
#define _PFGREMQUERY_UI_H_
...
extern Widget tu_remquery_dialog_widget(char * name,
                                        Widget parent,
                                        Widget ** warr_ret);

#define WI_REMQUERY_DIALOG 0
#define WI_PANELHELPTEXT 1
#define WI_MESSAGEBOX 2
#define WI_CONTINUEBUTTON 3
#define WI_GOBACKBUTTON 4
#define WI_REMOTEBUTTON 5
