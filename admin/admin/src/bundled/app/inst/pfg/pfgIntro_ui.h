...
#ifndef _PFGINTRO_UI_H_
#define _PFGINTRO_UI_H_
...
extern Widget tu_intro_dialog_widget(char * name,
                                     Widget parent,
                                     Widget ** warr_ret);

#define WI_INTRO_DIALOG 0
#define WI_PANELHELPTEXT 1
#define WI_MESSAGEBOX 2
#define WI_CONTINUEBUTTON 3
#define WI_GOBACKBUTTON 4
#define WI_EXITBUTTON 5
#define WI_HELPBUTTON 6
#define WI_BUTTON5 7
