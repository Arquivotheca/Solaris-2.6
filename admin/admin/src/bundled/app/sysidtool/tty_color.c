...
#pragma	ident	"@(#)tty_color.c 1.4 95/10/03"
 ...
 *
 * Since, sysidtool only uses 6 color pairs, the code now only defines
 * and uses those 6 to alleviate color problems in dtterms.
 */
